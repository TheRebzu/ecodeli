...
import {
  ...
  updateOnboardingStatusSchema} from "@/schemas/user/user-preferences.schema";

export const userPreferencesRouter = router({ getUserPreferences: protectedProcedure.query(async ({ ctx  }) => {
