...
export function getAuthErrorMessage(errorCode?: string): string | null {
  ...
  const errorMessages: Record<string, string> = {
    // Erreurs OAuth
    "OAuthSignin": "Une erreur est survenue lors de la connexion avec le fournisseur.",
    "OAuthCallback": "Une erreur est survenue lors du retour du fournisseur d'authentification.",
    "OAuthCreateAccount": "Impossible de créer un compte utilisateur avec le fournisseur sélectionné.",
    "EmailCreateAccount": "Impossible de créer un compte avec l'adresse email fournie.",
    "Callback": "Une erreur est survenue lors du traitement de l'authentification.",
    "OAuthAccountNotLinked": "Ce compte est déjà associé à une autre adresse email.",
    ...
    "EmailNotVerified": "Votre adresse email n'a pas été vérifiée. Veuillez vérifier votre boîte de réception.",
    ...
    "WeakPassword": "Le mot de passe est trop faible. Il doit contenir au moins 8 caractères avec des lettres, des chiffres et des caractères spéciaux.",
    "InvalidEmail": "L'adresse email n'est pas valide.",
    
    // Erreurs de vérification
    "InvalidVerificationToken": "Le token de vérification est invalide ou a expiré.",
