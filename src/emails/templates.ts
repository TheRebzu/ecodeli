...
type TemplateSet<T extends Record<string, unknown>> = Record<SupportedLanguage, T>;
 ...
 */
export const roleSpecificWelcomeTemplates: Record<UserRole, TemplateSet<EmailTemplate>> = {
  CLIENT: {
    fr: {
      subject: 'Bienvenue sur EcoDeli',
  ...
  MERCHANT: {
    ...
    en: {
      ...
      footer: 'Our team will review your information and contact you to finalize the partnership.',
    },
  },
  PROVIDER: {
    fr: {
    ...
    en: {
      ...
      footer: 'Our team will review your qualifications and contact you as soon as possible.',
    },
  },
  ADMIN: {
    fr: {
 ...
 */
export const postVerificationInstructionsTemplates: Record<UserRole, TemplateSet<EmailTemplate>> = {
  CLIENT: {
    fr: {
  ...
  MERCHANT: {
    ...
    en: {
      ...
      footer: 'Required information: business details, banking information, delivery preferences.',
    },
  },
  PROVIDER: {
    fr: {
...
export const passwordResetTemplates: TemplateSet<EmailTemplate> = {
  ...
  en: {
    ...
    greeting: 'Hello',
    message: 'You requested a password reset. To set a new password, please click the link below:',
    cta: {
 ...
 */
export const documentRejectedTemplates: TemplateSet<EmailTemplate & { reasonLabel: string }> = {
  fr: {
    ...
    footer: 'Veuillez télécharger un nouveau document pour continuer le processus de vérification.',
  },
  en: {
    ...
    footer: 'Please upload a new document to continue the verification process.',
  },
};
 ...
 */
export const verificationStatusChangedTemplates: TemplateSet<Record<string, EmailTemplate>> = {
  fr: {
    PENDING: {
      ...
      footer: 'Ce processus prend généralement entre 24 et 48 heures ouvrables.',
    },
    APPROVED: {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          ${
            template.cta ? `<p><a href="${ctaUrl}" class="button">${template.cta.text}</a></p>` : ''
          }
...
export const emailTemplates = {
  ...
  verification: {
    fr: {
      ...
      footer: "Si vous n'avez pas créé de compte sur EcoDeli, vous pouvez ignorer cet email.",
    },
    en: {
      ...
      footer: 'If you did not create an account on EcoDeli, you can ignore this email.',
    },
  },
  ...
  postVerification: {
    deliverer: {
      ...
      en: {
        ...
        footer: "If you have any questions, don't hesitate to contact our support team.",
      },
    },
    provider: {
      fr: {
