          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col">
                <span className="text-sm text-muted-foreground">{t('detailPage.boxSize')}</span>
                <span>{box.size} m³</span>
              </div>

              <div className="flex flex-col">
                <span className="text-sm text-muted-foreground">{t('detailPage.boxType')}</span>
            ...
            {box.features && box.features.length > 0 && (
              <div className="space-y-2">
                <span className="text-sm text-muted-foreground">{t('detailPage.features')}</span>
