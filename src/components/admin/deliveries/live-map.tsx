...
export function LiveMap({ deliveries }: LiveMapProps) {
  ...
  const refreshCoordinatesMutation =
    api.delivery.getLatestCoordinates.useMutation({
      onSuccess: (data) => {
      ...
      <div className="flex flex-col md:flex-row justify-between gap-4 mb-4">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
          ...
          >
            <ToggleGroupItem
              value="markers"
              aria-label="Afficher les marqueurs"
            >
            ...
            <ToggleGroupItem
              value="heatmap"
              aria-label="Afficher la carte thermique"
            >
            ...
            <ToggleGroupItem
              value="hybrid"
              aria-label="Afficher le mode hybride"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="md:col-span-2">
          ...
          <div className="bg-card rounded-md border h-[500px] relative">
            <MapComponent
              markers={
                mapMode === "markers" || mapMode === "hybrid" ? markers : []
              }
