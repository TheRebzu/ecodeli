            ...
            <CardHeader>
              <div className="flex items-start justify-between">
                <div className="space-y-1">
                  ...
                  <CardDescription>
                    Contrat #{negotiation.contract.contractNumber} • {negotiation.merchant.companyName}
                  </CardDescription>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                          ...
                          <div key={entry.id} className="flex gap-3 p-3 rounded-lg bg-gray-50">
                            <Avatar className="h-8 w-8">
                              <AvatarFallback className="text-xs">
                                {entry.performedBy.name.split(' ').map(n => n[0]).join('').substring(0, 2)}
                              </AvatarFallback>
                            </Avatar>
                  ...
                  {negotiation.status === 'PENDING' && (
                    <div className="flex items-center gap-2">
                        ...
                        <DialogContent>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              <Button
                                onClick={() => {
                                  onMakeCounterProposal(negotiation.id, { content: counterProposal });
                                  setCounterProposal('');
                                }}
                      ...
                      <Button
                        size="sm"
                        variant="default"
                        onClick={() => onAcceptProposal(negotiation.id, negotiation.merchantProposal)}
                        disabled={isLoading}
                      >
                        Accepter
                      </Button>
                  ...
                  {negotiation.status === 'IN_PROGRESS' && (
                    <Button
                      size="sm"
                      onClick={() => onCompleteNegotiation(negotiation.id, negotiation.adminCounterProposal)}
                      disabled={isLoading}
                    >
                      Finaliser
                    </Button>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Cette action est irréversible. La négociation sera définitivement annulée.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>Retour</AlertDialogCancel>
                          <AlertDialogAction
                            onClick={() => onCancelNegotiation(negotiation.id, 'Annulé par l\'administrateur')}
                          >
                            Annuler la négociation
                          </AlertDialogAction>
                        </AlertDialogFooter>
