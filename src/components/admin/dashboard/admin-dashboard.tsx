...
import { formatCurrency, generateChartColors } from '@/lib/utils/common';
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{deliveryData?.activeDeliveries || '0'}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{announcementData?.totalPublished || '0'}</div>
            <p className="text-xs text-muted-foreground">
