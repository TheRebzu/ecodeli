...
export function WarehouseManagement() {
  ...
  const filteredIssues = selectedWarehouse
    ? maintenanceIssues.filter(
        (issue) => issue.warehouseId === selectedWarehouse,
      )
    : maintenanceIssues;
  ...
  const globalStats = {
    ...
    totalBoxes: warehouses.reduce(
      (acc, warehouse) => acc + warehouse.totalBoxes,
      0,
    ),
    availableBoxes: warehouses.reduce(
      (acc, warehouse) => acc + warehouse.availableBoxes,
      0,
    ),
    occupancyRate: Math.round(
      (warehouses.reduce(
        (acc, warehouse) =>
          acc + (warehouse.totalBoxes - warehouse.availableBoxes),
        0,
      ) /
        ...
        >
          ...
          <DialogContent>
            ...
            <DialogFooter>
              <Button
                variant="outline"
                onClick={() => setCreateWarehouseDialogOpen(false)}
              >
                {t("cancel")}
              </Button>
        ...
        <TabsContent value="maintenance" className="space-y-4 mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {t("maintenanceIssuesDescription")}
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <TableBody>
                    {filteredIssues.map((issue) => (
                      <TableRow key={issue.id}>
                        ...
                        <TableCell>
                          {issue.boxName || t("entireWarehouse")}
                        </TableCell>
        ...
        <TabsContent value="analytics" className="space-y-4 mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {t("occupancyAnalyticsDescription")}
              </CardDescription>
            </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {t("seasonalOccupancyDescription")}
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {t("revenueByWarehouseDescription")}
                </CardDescription>
              </CardHeader>
              <CardContent className="h-60">
                <div className="flex h-full items-center justify-center">
