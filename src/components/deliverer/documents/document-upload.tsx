...
export function DocumentUpload({
  ...
  const availableDocumentTypes =
    documentTypesByRole[userRole] || documentTypesByRole.DELIVERER;
                  ...
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue
                            placeholder={t("upload.form.type.placeholder")}
                          />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                    ...
                    <FormDescription>
                      {t("upload.form.type.description")}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field  }) => (
                  <FormItem className="flex flex-col">
                    ...
                    <FormDescription>
                      {t("upload.form.expiryDate.description")}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
