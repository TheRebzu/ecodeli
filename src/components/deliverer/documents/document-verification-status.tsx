...
export default function DocumentVerificationStatus() {
  ...
  const totalDocuments =
    verificationStatus.applications?.[0]?.requiredDocuments?.length || 0;
    ...
    <div className="space-y-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {verificationStatus.applications[0].requiredDocuments.map(
                (doc: any) => (
                  <div
                    key={doc.id}
      ...
      {verificationStatus.overallStatus === "REJECTED" && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Des documents ont été rejetés. Veuillez consulter les raisons
            ci-dessus et soumettre de nouveaux documents.
          </AlertDescription>
        </Alert>
      )}
      ...
      {verificationStatus.overallStatus === "PENDING" && (
        <Alert>
          ...
          <AlertDescription>
            Vos documents sont en cours d'examen. Ce processus peut prendre 1-3
            jours ouvrables.
          </AlertDescription>
        </Alert>
      )}
      ...
      {verificationStatus.overallStatus === "APPROVED" && (
        <Alert variant="success">
          ...
          <AlertDescription>
            Félicitations ! Votre compte est maintenant vérifié et vous pouvez
            commencer à accepter des livraisons.
          </AlertDescription>
        </Alert>
      )}
    </div>
