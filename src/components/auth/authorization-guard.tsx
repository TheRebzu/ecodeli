...
import { UserRole, Permission, hasPermission, canAccessRoute } from '@/lib/auth/permissions'
      ...
      <Card className="border-red-200">
        <CardHeader>
          <div className="flex items-center space-x-2">
            ...
            <CardTitle className="text-red-600">Authentification requise</CardTitle>
          </div>
        </CardHeader>
        <CardContent>
      ...
      <Card className="border-red-200">
        ...
        <CardContent>
          <p className="text-gray-600">
            Vous n'avez pas les permissions nécessaires (rôle {requiredRole} requis).
          </p>
        </CardContent>
      </Card>
    )
    ...
    return fallback || (
      <Card className="border-red-200">
        <CardHeader>
          <div className="flex items-center space-x-2">
            <ShieldAlert className="w-5 h-5 text-red-600" />
            <CardTitle className="text-red-600">Permission insuffisante</CardTitle>
          </div>
        </CardHeader>
        <CardContent>
          <p className="text-gray-600">
