              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg flex justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Électricité - Installation luminaire</p>
                  </div>
                  <div className="text-right">
                ...
                <div className="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg flex justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Plomberie - Remplacement chauffe-eau</p>
                  </div>
                  <div className="text-right">
