...
export function TutorialOverlay({
  ...
  const estimatedTimeRemaining = totalSteps > 0 
      ...
      >
        ...
        {isMission1 && (
          <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <p className="mt-2 text-sm text-red-700 dark:text-red-300">
              Ce tutoriel doit être complété avant de pouvoir accéder à la plateforme.
              Il vous permettra de comprendre les fonctionnalités essentielles d'EcoDeli.
            </p>
        ...
        {isBlocking && !isMission1 && (
          <Alert className="mb-6 border-yellow-200 bg-yellow-50">
            ...
            <AlertDescription>
              Ce tutoriel est nécessaire pour accéder aux fonctionnalités complètes de la plateforme.
            </AlertDescription>
          </Alert>
        )}
