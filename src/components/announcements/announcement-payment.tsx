...
export function AnnouncementPayment() {
  ...
  const createPaymentSession = api.announcementPayment.createPaymentSession.useMutation({
  ...
  const serviceFee = announcement ? announcement.price * 0.10 : 0; // 10% de frais de service
