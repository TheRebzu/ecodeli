...
export function DeliveryTimeline({ deliveryId, events = [], isLoading = false }: DeliveryTimelineProps) {
            ...
            <TimelineItem key={event.id || index}>
              ...
              <TimelineContent>
                <div className="ml-4">
                  ...
                  <p className="text-sm text-muted-foreground">{event.description || getDefaultDescription(event.type, t)}</p>
