...
export function AnnouncementForm({ initialValues, isSubmitting = false, onSubmit }: AnnouncementFormProps) {
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar
                          ...
                          disabled={(date) => 
                            date < new Date() || 
                            (form.getValues().pickupDateStart && date < form.getValues().pickupDateStart)
                          }
                          initialFocus
                        />
                      </PopoverContent>
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar
                          ...
                          disabled={(date) => 
                            date < new Date() || 
                            (form.getValues().deliveryDateStart && date < form.getValues().deliveryDateStart)
                          }
                          initialFocus
                        />
                      </PopoverContent>
