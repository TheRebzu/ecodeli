...
const formSchema = z.object({
  ...
  weightPricing: z.array(z.object({
    minWeight: z.number(),
    maxWeight: z.number(),
    price: z.number(),
  })).optional(),
  distancePricing: z.array(z.object({
                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="WEIGHT_BASED">{t('pricingMethods.weightBased')}</SelectItem>
                      <SelectItem value="DISTANCE_BASED">{t('pricingMethods.distanceBased')}</SelectItem>
