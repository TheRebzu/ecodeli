...
import { 
  Package, ShoppingBag, MapPin, Calendar, Clock, Truck, 
  CircleDollarSign, Info, Tag, User 
} from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-muted-foreground">{announcement.pickup?.formattedAddress || t('notSpecified')}</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-muted-foreground">{announcement.delivery?.formattedAddress || t('notSpecified')}</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-muted-foreground">
                  {announcement.deliveryDate ? formatDate(announcement.deliveryDate) : t('flexible')}
                </div>
              </div>
            </div>
