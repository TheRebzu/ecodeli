        ...
        <Card className="w-full max-w-2xl shadow-2xl border-2 border-red-200">
          <CardHeader className="text-center space-y-4">
            ...
            <CardDescription className="text-lg">
              Bienvenue dans l'aventure EcoDeli ! Pour commencer à utiliser la
              plateforme, vous devez d'abord compléter notre tutoriel
              obligatoire.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <Alert className="border-red-200 bg-red-50">
              ...
              <AlertDescription className="text-red-700">
                Ce tutoriel vous explique les fonctionnalités essentielles
                d'EcoDeli et les pratiques de livraison durable. Il ne prend que
                quelques minutes.
              </AlertDescription>
            </Alert>
