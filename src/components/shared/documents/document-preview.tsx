...
export default function DocumentPreview({
  ...
  const documentLabel = DOCUMENT_LABELS[document.documentType] || document.documentType;
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {documentLabel}
            {document.version && <span className="text-sm text-muted-foreground">v{document.version}</span>}
          </DialogTitle>
          <DialogDescription>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {onReplace && (document.status === 'REJECTED' || isDocumentExpired(document.expiryDate)) && (
            ...
            <Card className="border-red-200 bg-red-50">
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-red-800">Document rejeté</h4>
            ...
            <Card className="border-red-200 bg-red-50">
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-red-800">Document expiré</h4>
                    <p className="text-sm text-red-700 mt-1">
                      Ce document a expiré le {format(document.expiryDate!, 'dd/MM/yyyy', { locale: fr })}.
            ...
            <Card className="border-orange-200 bg-orange-50">
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-orange-800">Document expire bientôt</h4>
                    <p className="text-sm text-orange-700 mt-1">
                      Ce document expire le {format(document.expiryDate!, 'dd/MM/yyyy', { locale: fr })}.
                  ...
                  <div className="space-y-3">
                    {document.uploadedAt && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span>{format(document.uploadedAt, 'dd/MM/yyyy à HH:mm', { locale: fr })}</span>
                      </div>
                    )}
                    ...
                    {document.verifiedAt && document.status === 'APPROVED' && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-green-600">
                          {format(document.verifiedAt, 'dd/MM/yyyy à HH:mm', { locale: fr })}
                        </span>
                      </div>
                    )}
                    ...
                    {document.expiryDate && (
                      <div className="flex items-center gap-2 text-sm">
                        <Calendar className={cn(
                          "h-4 w-4",
                          isDocumentExpired(document.expiryDate) ? "text-red-500" :
                          isDocumentExpiring(document.expiryDate) ? "text-orange-500" :
                          "text-muted-foreground"
                        )} />
                        <span className="font-medium">Expire le:</span>
                        <span className={cn(
                          isDocumentExpired(document.expiryDate) ? "text-red-600" :
                          isDocumentExpiring(document.expiryDate) ? "text-orange-600" :
                          ""
                        )}>
                          {format(document.expiryDate, 'dd/MM/yyyy', { locale: fr })}
                        </span>
                      </div>
                    )}
                    ...
                    {document.checksum && (
                      <div className="flex items-start gap-2 text-sm">
                        ...
                        <span className="font-mono text-xs break-all">{document.checksum}</span>
                      </div>
                    )}
                  </div>
                </div>
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-sm text-muted-foreground">
                        Ce document a été validé automatiquement avec un score de confiance de{' '}
