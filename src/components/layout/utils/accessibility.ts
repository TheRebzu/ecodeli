...
export class KeyboardShortcuts {
  ...
  private isInInput(target: Element): boolean {
    ...
    return inputElements.includes(target.tagName.toLowerCase()) ||
  ...
  setupDefaultShortcuts() {
    ...
    this.register('alt+s', () => document.querySelector<HTMLInputElement>('[data-search]')?.focus())
    ...
    // Interface
    this.register('ctrl+k', () => document.querySelector<HTMLInputElement>('[data-search]')?.focus())
