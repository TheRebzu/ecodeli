...
export function DeliveryTable({
  ...
  const renderStatusBadge = (status: string) => {
    ...
    switch (status) {
      ...
      case 'ASSIGNED':
        return <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200">Assignée</Badge>;
      case 'IN_PROGRESS':
        return <Badge variant="outline" className="bg-purple-50 text-purple-700 border-purple-200">En cours</Badge>;
      case 'DELIVERED':
        return <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">Livrée</Badge>;
      case 'COMPLETED':
        return <Badge variant="outline" className="bg-green-100 text-green-800 border-green-300">Terminée</Badge>;
      case 'CANCELLED':
        return <Badge variant="outline" className="bg-red-50 text-red-700 border-red-200">Annulée</Badge>;
      case 'PROBLEM':
        return <Badge variant="outline" className="bg-red-100 text-red-800 border-red-300">Problème</Badge>;
      default:
            ...
            {deliveries.map(delivery => (
              ...
              >
                ...
                <TableCell className="hidden md:table-cell">
                  {delivery.createdAt ? format(new Date(delivery.createdAt), 'PPP', { locale: fr }) : ''}
                </TableCell>
                <TableCell className="hidden md:table-cell">
