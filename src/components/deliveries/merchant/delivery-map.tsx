              ...
              {mapDeliveries.map(delivery => (
                <div key={delivery.id}>
                  ...
                  >
                    <Popup>
                      <div className="text-sm">
                        <h3 className="font-bold mb-1">{delivery.announcement?.title || t('untitled')}</h3>
                  ...
                  <Polyline
                    ...
                    weight={
                      selectedDelivery && selectedDelivery.id === delivery.id ? 3 : 2
                    }
                    opacity={
                      selectedDelivery && selectedDelivery.id === delivery.id ? 1 : 0.7
                    }
                    dashArray={
                      delivery.status === 'COMPLETED' ? "" : "5,5"
                    }
                  />
                </div>
              ))}
