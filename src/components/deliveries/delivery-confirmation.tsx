...
const confirmationSchema = z.object({
  ...
  recipientName: z.string().min(2, { message: 'Veuillez indiquer qui a reçu le colis' }),
...
const confirmationSchemaWithSafeLocation = confirmationSchema.superRefine((data, ctx) => {
  if (data.safeLocation && (!data.safeLocationDetails || data.safeLocationDetails.length < 5)) {
    ctx.addIssue({
...
type ConfirmationFormValues = z.infer<typeof confirmationSchemaWithSafeLocation>;
      ...
      <Card className={className}>
        ...
        <CardContent>
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-muted-foreground text-center">{t('confirmationSent')}</p>
          </div>
        </CardContent>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="rounded-md border p-3 bg-muted/30">
                <p className="text-sm">
                  <span className="font-medium">{t('orderNumber')}: </span>#{deliveryId.slice(-6)}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>{t('confirmationCodeHelp')}</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <FormDescription>{t('safeLocationDescription')}</FormDescription>
                      </div>
                    </FormItem>
                  )}
                />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>{t('safeLocationDetailsHelp')}</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
              ...
              <div className="space-y-3">
                <div>
                  <h3 className="text-sm font-medium mb-2">{t('photoEvidenceLabel')}</h3>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 bg-muted/20">
                    ...
                    <div className="space-y-1 leading-none">
                      ...
                      <FormDescription>{t('confirmReceiptDescription')}</FormDescription>
                    </div>
                  </FormItem>
                )}
              />
