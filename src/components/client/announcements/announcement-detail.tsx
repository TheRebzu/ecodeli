      ...
      switch (announcement.status) {
        ...
        case "PENDING":
          return (
            <>
              <Button
                variant="default"
                onClick={() => onPayNow && onPayNow(announcement.id)}
              >
        ...
        case "COMPLETED":
          return (
            <Button
              variant="outline"
              onClick={() => onComplete && onComplete(announcement.id)}
            >
                ...
                {announcement.client && (
                  <Button
                    ...
                    onClick={() =>
                      ...
                      onChatWith(announcement.client.id)
                    }
                  >
                    <MessageSquare className="mr-2 h-4 w-4" />
                    {t("chatWithClient")}
        ...
        <HoverCardContent className="w-80">
          ...
          <div className="mt-4">
            <Button
              size="sm"
              className="w-full"
              onClick={() => onChatWith && onChatWith(user.id)}
            >
              <MessageSquare className="mr-2 h-4 w-4" />
              {t("startChat")}
            </Button>
            ...
            {application.status === "PENDING" && (
              <CardFooter className="flex gap-2 justify-end">
                <Button
                  ...
                  variant="default"
                  onClick={() =>
                    onAccept && onAccept(announcement.id, application.id)
                  }
                >
                  {t("accept")}
                </Button>
                <Button
                  ...
                  variant="outline"
                  onClick={() =>
                    onReject && onReject(announcement.id, application.id)
                  }
                >
                  {t("reject")}
                </Button>
      ...
      <CardContent className="p-0">
        ...
        >
                  ...
                  <div className="flex gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm">
                        ...
                        {announcement.deliveryTimeWindow &&
                          ` (${announcement.deliveryTimeWindow})`}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <div>
                        <p className="text-sm">
                          {t("dimensions")}:
                          {announcement.width
                            ? ` ${t("width")}: ${announcement.width} cm`
                            : ""}
                          {announcement.height
                            ? ` ${t("height")}: ${announcement.height} cm`
                            : ""}
                          {announcement.length
                            ? ` ${t("length")}: ${announcement.length} cm`
                            : ""}
                        </p>
                      </div>
                    </div>
          ...
          <TabsContent value="photos" className="p-6 pt-4">
            ...
            <Dialog
              open={!!currentPhoto}
              onOpenChange={() => setCurrentPhoto(null)}
            >
