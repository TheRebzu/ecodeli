...
export function ClientStorageStats({
  ...
  const getExperienceLevel = (totalReservations: number) => {
    ...
    if (totalReservations >= 5)
      return { level: 'Intermédiaire', color: 'text-yellow-600', badge: 'yellow' };
        ...
        <>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Votre contribution à la durabilité</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          {stats.favoriteBoxes && stats.favoriteBoxes.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Les box que vous utilisez le plus souvent</CardDescription>
              </CardHeader>
              <CardContent>
