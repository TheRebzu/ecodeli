                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Ces informations aideront le gestionnaire de l'entrepôt à mieux vous
                          servir
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
            ...
            <Card>
              ...
              <CardContent>
                <Alert>
                  ...
                  <AlertDescription>
                    Cette interface simule un processus de paiement. Dans un environnement de
                    production, vous seriez redirigé vers un processeur de paiement sécurisé.
                  </AlertDescription>
                </Alert>
    ...
    <div className="max-w-4xl mx-auto space-y-6">
        ...
        <CardContent className="pt-6">
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              {(['selection', 'details', 'payment', 'confirmation'] as ReservationStep[]).map(
                (stepName, index) => {
                  const StepIcon = getStepIcon(stepName);
                  const isActive = step === stepName;
                  const isCompleted =
                    ['selection', 'details', 'payment', 'confirmation'].indexOf(step) > index;
      ...
      {createReservation.error && (
        <Alert variant="destructive">
          ...
          <AlertDescription>{createReservation.error.message}</AlertDescription>
        </Alert>
      )}
    </div>
  );
