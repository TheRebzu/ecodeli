      ...
      <CardFooter className="flex flex-wrap gap-2 justify-end">
        ...
        {(isDemo || isDemoMode) && status === 'PENDING' && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="outline" size="sm" onClick={handleSimulateSuccess} className="bg-green-50 border-green-200 text-green-700 hover:bg-green-100">
        ...
        {(isDemo || isDemoMode) && status === 'PENDING' && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="outline" size="sm" onClick={handleSimulateFailure} className="bg-red-50 border-red-200 text-red-700 hover:bg-red-100">
        ...
        {(isDemo || isDemoMode) && status === 'COMPLETED' && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="outline" size="sm" onClick={handleSimulateRefund} className="bg-blue-50 border-blue-200 text-blue-700 hover:bg-blue-100">
        ...
        {(isDemo || isDemoMode) && status === 'COMPLETED' && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="outline" size="sm" onClick={handleSimulateDispute} className="bg-orange-50 border-orange-200 text-orange-700 hover:bg-orange-100">
