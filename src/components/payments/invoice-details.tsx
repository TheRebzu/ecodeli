...
export function InvoiceDetails({
  ...
  const { data: invoiceData, isLoading, refetch } = isDemo
  ...
  const getDisplayInvoice = (): DemoInvoiceDetails => {
    ...
    return {
      ...
      totalExclTax: Number(realInvoice.totalAmount || realInvoice.amount) - Number(realInvoice.taxAmount || 0),
      ...
      // Adapter les items
      items: realInvoice.items?.map((item: any) => ({
        id: item.id,
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm mt-2">
                    ...
                    {displayInvoice.issuerDetails.phone && <p>{displayInvoice.issuerDetails.phone}</p>}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {displayInvoice.notes && (
              <div>
                ...
                <p className="text-sm text-muted-foreground whitespace-pre-line">{displayInvoice.notes}</p>
              </div>
            )}
            ...
            {displayInvoice.paymentInstructions && (
              <div>
                ...
                <p className="text-sm text-muted-foreground whitespace-pre-line">{displayInvoice.paymentInstructions}</p>
              </div>
            )}
          </div>
          ...
          {displayInvoice.termsAndConditions && (
            <div>
              ...
              <div className="mt-4">
                ...
                <p className="text-sm text-muted-foreground whitespace-pre-line">{displayInvoice.termsAndConditions}</p>
              </div>
            </div>
          )}
        </CardContent>
