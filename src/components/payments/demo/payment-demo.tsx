...
export function PaymentDemo() {
  ...
  const { simulateSuccess, simulateFailure, simulateRefund, simulateDispute } = usePaymentConfirmation();
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2 mt-8">
                ...
                <p className="text-sm text-muted-foreground mb-4">{t('stripeElementsDescription')}</p>
                {clientSecret ? (
