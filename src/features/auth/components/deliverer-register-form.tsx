...
import { delivererRegisterSchema, type DelivererRegisterData } from "@/features/auth/schemas/auth.schema"
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
        <p className="text-sm text-yellow-800">
          📄 <strong>Documents requis :</strong> Après inscription, vous devrez fournir 
          une pièce d'identité et un justificatif de transport pour validation.
        </p>
      </div>
