...
export default function ReferralInput({ onReferralCodeChange, defaultValue }: ReferralInputProps) {
  ...
  return (
    <div className="space-y-3">
      <div className="space-y-2">
        ...
        <div className="relative">
          <Input
            ...
            className={`${
              codeInfo?.isValid ? 'border-green-500 focus:border-green-500' :
              codeInfo?.isValid === false ? 'border-red-500 focus:border-red-500' :
              'border-gray-300'
            }`}
      ...
      {codeInfo && (
        <Card className={`${
          codeInfo.isValid ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'
        }`}>
              ...
              <div className="space-y-2">
                ...
                {codeInfo.referrerName && (
                  <p className="text-sm text-green-700">
                    Vous avez été parrainé par <strong>{codeInfo.referrerName}</strong>
                  </p>
                )}
                ...
                <p className="text-xs text-green-600">
                  🎉 Votre bonus de bienvenue sera crédité après votre inscription !
                </p>
              </div>
            ) : (
              <div className="space-y-2">
                ...
                <p className="text-sm text-red-700">
                  {codeInfo.isExpired ? 'Ce code de parrainage a expiré.' :
                   codeInfo.isMaxUsage ? 'Ce code de parrainage a atteint sa limite d\'utilisation.' :
          ...
          <CardContent className="p-3">
            <div className="flex items-start gap-2">
              ...
              <div className="text-xs text-blue-700">
                <p className="font-medium mb-1">Programme de parrainage EcoDeli</p>
                <p>
                  Recevez un bonus de bienvenue en utilisant le code de parrainage d'un ami. 
                  Vous pourrez ensuite parrainer vos propres amis et gagner des récompenses !
                </p>
              </div>
            </div>
          </CardContent>
