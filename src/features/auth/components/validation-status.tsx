    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Badge
            variant={
              getOverallStatus() === "complete" ? "default" : "secondary"
            }
            className={
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg border">
            <Mail
              className={`h-5 w-5 ${status.emailVerified ? "text-green-500" : "text-orange-500"}`}
            />
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg border">
            <User
              className={`h-5 w-5 ${status.profileVerified ? "text-green-500" : "text-blue-500"}`}
            />
            <div className="flex-1">
        ...
        {showActions && requiredAction && (
          <div className="flex gap-2">
            <Button asChild variant={requiredAction.variant} className="flex-1">
              <Link href={requiredAction.href}>{requiredAction.action}</Link>
            </Button>
        ...
        {getOverallStatus() === "complete" && (
          <Alert className="border-green-200 bg-green-50">
            ...
            <AlertDescription className="text-green-800">
              Félicitations ! Votre compte est entièrement validé et vous pouvez
              utiliser tous les services EcoDeli.
            </AlertDescription>
          </Alert>
        )}
      </CardContent>
