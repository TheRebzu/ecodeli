...
export type InternationalPurchaseDetails = z.infer<
  typeof internationalPurchaseDetailsSchema
>;
...
export const createAnnouncementSchema = z
  ...
  .refine(
    (data) => {
      ...
      if (
        data.type === "INTERNATIONAL_PURCHASE" &&
        !data.internationalPurchaseDetails
      ) {
        return false;
      }
...
export const searchAnnouncementsSchema = z.object({
  ...
  type: z
    ...
    .pipe(announcementTypeSchema.optional()),
  status: z
    .string()
    .nullable()
    .transform((val) => val || undefined)
    .pipe(announcementStatusSchema.optional()),
  deliveryType: z
    .string()
    .nullable()
    .transform((val) => val || undefined)
    .pipe(deliveryTypeSchema.optional()),
  ...
  sortBy: z
    ...
    .pipe(z.enum(["createdAt", "pickupDate", "basePrice", "distance"])),
  sortOrder: z
    .string()
    .nullable()
...
export type SearchAnnouncementsInput = z.infer<
  typeof searchAnnouncementsSchema
>;
