...
export const internationalPurchaseDetailsSchema = z.object({
  ...
  returnPolicy: z
    .enum(["NO_RETURNS", "STORE_POLICY", "FULL_REFUND"])
    .default("STORE_POLICY"),
...
>;
export type InternationalPurchaseAnnouncement = z.infer<
  typeof internationalPurchaseAnnouncementSchema
>;
