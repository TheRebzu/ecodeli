...
import type { Announcement, PaginatedAnnouncementsResponse } from "@/features/announcements/types/announcement.types"
...
export function useAnnouncements({
  ...
  const fetchAnnouncements = useCallback(async (append = false) => {
    setLoading(true)
    setError(null)
  ...
  }, [filters, paginationState.page, paginationState.limit, sortBy, sortOrder, getApiEndpoint])
