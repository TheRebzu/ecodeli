...
import { createAnnouncementSchema, type CreateAnnouncementInput } from '../../schemas/announcement.schema'
...
import { Package, Users, Plane, ShoppingCart, Globe, Home, Heart, ShoppingCartIcon } from 'lucide-react'
...
export function CreateAnnouncementForm({ onSuccess, initialData }: CreateAnnouncementFormProps) {
  ...
  const onSubmit = async (data: CreateAnnouncementInput) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Votre annonce est maintenant visible par nos livreurs et prestataires.",
        duration: 5000,
      })
  ...
  const selectedTypeInfo = announcementTypes.find(t => t.value === selectedType)
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ex: Livraison urgente Paris-Lyon" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h3 className="font-semibold text-lg">📍 Adresse de départ</h3>
                  <FormField
                    control={form.control}
                ...
                <div className="space-y-4">
                  <h3 className="font-semibold text-lg">🎯 Adresse d'arrivée</h3>
                  <FormField
                    control={form.control}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Vêtements, livres, objets divers..." {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
              ...
              {selectedTypeInfo && (
                <Card className="p-4 bg-gray-50">
                  <h3 className="font-semibold mb-2">📋 Résumé de votre annonce</h3>
                  <div className="flex items-center gap-2 mb-2">
                    <Badge variant="secondary" className={selectedTypeInfo.color}>
                  ...
                  <p className="text-sm text-gray-600">
                    {form.watch('startLocation.city')} → {form.watch('endLocation.city')} • {form.watch('price')}€
                  </p>
                </Card>
              )}
