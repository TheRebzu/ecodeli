...
interface AddressPickerProps {
  ...
  onPickupSelect?: (address: string, coordinates: { lat: number; lng: number }) => void
  onDeliverySelect?: (address: string, coordinates: { lat: number; lng: number }) => void
...
export const AddressPicker: React.FC<AddressPickerProps> = ({
  ...
  const getMapCenter = (): [number, number] => {
    ...
    if (deliveryCoordinates) return [deliveryCoordinates.lat, deliveryCoordinates.lng]
