            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-green-700 mb-4">
                  EcoDeli vous connecte avec des livreurs de confiance pour
                  transporter vos colis en toute sécurité. Choisissez le type de
                  colis et remplissez les détails.
                </p>
                  ...
                  <label key={type.value} className="relative">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setValue(
                          "price",
                          getSuggestedPrice(e.target.value, weight),
                        );
                      }}
                    />
            ...
            <CardContent className="pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Poids: {selectedPackageType.minWeight}kg -{" "}
                    {selectedPackageType.maxWeight}kg
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <Euro className="h-4 w-4 text-blue-600" />
                  <span>
                    Prix de base: à partir de {selectedPackageType.basePrice}€
                  </span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {errors.endLocation?.address && (
                  <p className="mt-1 text-sm text-red-600">
                    {errors.endLocation.address.message}
                  </p>
                )}
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <Input
                  {...register("packageDetails.weight", {
                    ...
                    onChange: (e) => {
                      ...
                      setValue(
                        "price",
                        getSuggestedPrice(currentType, newWeight),
                      );
                    },
                  })}
                  type="number"
                ...
                {selectedPackageType && (
                  <p className="mt-1 text-xs text-gray-500">
                    Limite: {selectedPackageType.minWeight}kg -{" "}
                    {selectedPackageType.maxWeight}kg
                  </p>
                )}
              ...
              <div>
                <label
                  htmlFor="packageDetails.dimensions"
                  className="block text-sm font-medium text-gray-700 mb-1"
                >
                  Dimensions (cm)
                </label>
