...
class AnnouncementBusinessService {
  ...
  /**
   * Matching automatique avec les trajets des livreurs - FONCTIONNALITÉ CRITIQUE
   */
  private async triggerRouteMatching(announcementId: string): Promise<void> {
    try {
      ...
      // Créer les nouveaux matches et envoyer les notifications OneSignal
  ...
  /**
   * Vérifie les limites d'abonnement selon les plans EcoDeli
   */
  ...
  /**
   * Retourne les limites selon le plan d'abonnement EcoDeli
   */
...
export const announcementBusinessService = new AnnouncementBusinessService();
