...
export function DocumentValidationManager() {
  ...
  const getValidationProgress = () => {
    ...
    const approved =
      Object.values(documentStatus).filter((status) => status === "APPROVED")
        .length - 1; // -1 pour exclure allApproved
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Transmettez vos pièces justificatives pour être validé comme livreur
          EcoDeli
        </p>
      </div>
          ...
          <div className="space-y-4">
            ...
            {documentStatus?.allApproved ? (
              <Alert>
                ...
                <AlertDescription>
                  Votre profil est validé ! Vous pouvez maintenant accepter des
                  livraisons.
                </AlertDescription>
              </Alert>
            ) : (
              <Alert>
                ...
                <AlertDescription>
                  Veuillez compléter la validation de tous vos documents pour
                  pouvoir effectuer des livraisons.
                </AlertDescription>
              </Alert>
            )}
          </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {(doc.status === "MISSING" ||
                      doc.status === "REJECTED") && (
                      <Dialog
                        open={uploadDialog && selectedDocType === doc.type}
                        onOpenChange={(open) => {
        ...
        <CardContent>
          <div className="space-y-3 text-sm">
            <div className="flex items-start gap-2">
              ...
              <span>
                La validation des documents peut prendre jusqu'à 48h ouvrées
              </span>
            </div>
            <div className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-green-600 mt-0.5" />
            ...
            <div className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-green-600 mt-0.5" />
              <span>
                Une fois validé, vous pourrez immédiatement accepter des
                livraisons
              </span>
            </div>
            <div className="flex items-start gap-2">
              ...
              <span>
                En cas de refus, vous recevrez une notification avec les motifs
              </span>
            </div>
          </div>
        </CardContent>
