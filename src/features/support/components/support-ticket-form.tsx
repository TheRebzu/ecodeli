  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Décrivez votre problème ou votre demande. Notre équipe vous répondra
      ...
      <CardContent>
        {submitMessage && (
          <Alert
            className={`mb-6 ${submitMessage.type === "success" ? "border-green-200 bg-green-50" : "border-red-200 bg-red-50"}`}
          >
            ...
            {deliveryId && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-700">
                  Ce ticket sera automatiquement lié à votre livraison #
                  {deliveryId.slice(-8)}
                </p>
              </div>
            )}
