...
export type UpdateStripeSubscriptionInput = z.infer<typeof updateStripeSubscriptionSchema>
...
export const validateSubscriptionPlan = (plan: string): plan is SubscriptionPlan => {
