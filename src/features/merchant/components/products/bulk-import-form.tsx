          ...
          <CardContent className="space-y-4">
            <div className="border-2 border-dashed border-muted-foreground rounded-lg p-6">
              <div className="text-center">
                ...
                <h3 className="mt-2 text-sm font-medium">{t('import.dragDrop')}</h3>
                <p className="mt-1 text-sm text-muted-foreground">{t('import.orClick')}</p>
                <div className="mt-4">
                  <Input
                    type="file"
                    accept=".csv,.xlsx,.xls"
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <h4 className="text-sm font-medium">{t('import.supportedColumns')}</h4>
            ...
            <div className="space-y-4">
              <div className="flex space-x-4">
                <Badge variant="default" className="flex items-center space-x-1">
                  ...
                  <span>{t('import.successCount', { count: successCount })}</span>
                </Badge>
                {errorCount > 0 && (
