...
export default function ZoneManager({ merchantId }: ZoneManagerProps) {
        ...
        setZones([
          ...
          },
          {
            ...
            timeSlots: [
              {
                day: "Mercredi",
                slots: [{ start: "10:00", end: "16:00", capacity: 12 }],
              },
            ],
            specialRules: {
              minOrderAmount: 25.0,
  ...
  const handleSaveZone = async (zoneData: Partial<DeliveryZone>) => {
    try {
      ...
      const url = isEditing
        ? `/api/merchant/zones/${zoneData.id}`
        : "/api/merchant/zones";
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div>
                    ...
                    <span className="font-medium">
                      {zone.priceStructure.basePrice.toFixed(2)}€
                    </span>
                  </div>
                  <div>
                    <span className="text-muted-foreground">Par km: </span>
                    <span className="font-medium">
                      {zone.priceStructure.pricePerKm.toFixed(2)}€
                    </span>
                  </div>
                  <div>
                    <span className="text-muted-foreground">Gratuit dès: </span>
                    <span className="font-medium">
                      {zone.priceStructure.freeThreshold.toFixed(2)}€
                    </span>
                  </div>
                  <div>
                    ...
                    <span className="font-medium">
                      {zone.priceStructure.maxDistance}km
                    </span>
                  </div>
                </div>
              </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Configurez les paramètres de livraison pour cette zone
              géographique
            </DialogDescription>
          </DialogHeader>
        ...
        <TabsContent value="general" className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  checked={zone.isActive}
                  onCheckedChange={(checked) =>
                    setZone((prev) => ({ ...prev, isActive: checked }))
                  }
                />
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) =>
                setZone((prev) => ({ ...prev, description: e.target.value }))
              }
        ...
        <TabsContent value="schedule" className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              ...
              Les clients pourront choisir parmi ces créneaux lors de leur
              commande.
            </AlertDescription>
          </Alert>
