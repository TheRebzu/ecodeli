...
export function ProviderDocumentsManager() {
  const { documents, summary, loading, error, fetchDocuments, deleteDocument } =
  ...
  const progressValue = summary
    ? (summary.approved / summary.requiredDocuments.length) * 100
    : 0;
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Badge variant={summary?.canActivate ? "default" : "secondary"}>
              {summary?.approved || 0}/{summary?.requiredDocuments.length || 0}{" "}
              validés
            </Badge>
          </CardTitle>
          <CardDescription>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex items-center space-x-2">
                        <Badge
                          variant="secondary"
                          className={getStatusColor(latestDoc.validationStatus)}
                        >
                    ...
                    {latestDoc.validationStatus === "REJECTED" &&
