...
import { Search, MapPin, Clock, Euro, User, Calendar, AlertTriangle, CheckCircle } from 'lucide-react'
...
export function ServiceRequestsBrowser() {
  ...
  const { serviceRequests, isLoading, error, applyToServiceRequest } = useProviderServiceRequests()
    ...
    return (
      <Card className="h-full">
        <CardHeader className="pb-3">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <CardTitle className="text-lg">{serviceRequest.title}</CardTitle>
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-700 line-clamp-3">{serviceRequest.description}</p>
          
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div className="flex items-center gap-2">
              <Euro className="w-4 h-4 text-green-600" />
              <span><strong>{serviceRequest.budget}€</strong></span>
            </div>
            <div className="flex items-center gap-2">
