...
export const providerAutoentrepreneurSchema = z.object({
  legalStatus: z.enum(['AUTOENTREPRENEUR', 'SASU', 'EURL', 'SAS', 'EI']).default('AUTOENTREPRENEUR'),
...
export type ProviderAutoentrepreneurData = z.infer<typeof providerAutoentrepreneurSchema>
