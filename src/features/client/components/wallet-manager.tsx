    ...
    try {
      ...
      if (walletData) {
        setWalletData({
          ...
          totalWithdrawals: walletData.totalWithdrawals + parseFloat(withdrawalAmount),
          transactions: [result.transaction, ...walletData.transactions]
        })
      }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{walletData.totalDeposits.toFixed(2)}€</div>
            <p className="text-xs text-muted-foreground">
              Depuis le début
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-600">{walletData.totalWithdrawals.toFixed(2)}€</div>
            <p className="text-xs text-muted-foreground">
              Depuis le début
            </p>
          </CardContent>
