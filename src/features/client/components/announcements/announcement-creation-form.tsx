...
export function AnnouncementCreationForm() {
  ...
  const announcementTypes = [
    ...
    { value: 'DOCUMENT_DELIVERY', label: 'Livraison de documents', icon: Package },
    { value: 'SHOPPING_DELIVERY', label: 'Livraison de courses', icon: Package },
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Trouvez un livreur pour votre colis en quelques étapes</p>
        ...
        <div className="flex items-center mt-6 mb-8">
          {[1, 2, 3, 4].map((num) => (
            <div key={num} className="flex items-center">
              ...
              {num < 4 && <div className={`w-12 h-1 mx-2 ${step > num ? 'bg-primary' : 'bg-muted'}`} />}
            </div>
          ))}
        </div>
      </div>
          ...
          {step === 4 && (
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                {formData.urgent && <Badge variant="destructive">Express</Badge>}
              </div>
            </div>
          )}
            ...
            {step < 4 ? (
              <Button 
                ...
                disabled={
                  ...
                  (step === 3 && (!formData.pickupAddress || !formData.deliveryAddress))
                }
              >
                Suivant
              </Button>
