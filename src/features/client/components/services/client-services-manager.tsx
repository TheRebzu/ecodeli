...
export default function ClientServicesManager({
  ...
  const filteredProviders = providers.filter((provider) => {
    ...
    if (
      filters.maxDistance &&
      provider.distance &&
      provider.distance > parseFloat(filters.maxDistance)
    ) {
      return false;
    }
    ...
    if (
      filters.maxPrice &&
      provider.services.every((s) => s.price > parseFloat(filters.maxPrice))
    ) {
      return false;
    }
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center gap-4 text-sm text-gray-600">
                    <div className="flex items-center gap-1">
                      ...
                      <span>
                        {provider.experience} {t("years_experience")}
                      </span>
                    </div>
                    <div className="flex items-center gap-1">
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              <Label htmlFor="review">
                                {t("rating_dialog.review")}
                              </Label>
                              <Textarea
                                id="review"
                                placeholder={t(
                                  "rating_dialog.review_placeholder",
                                )}
                              />
                            </div>
                          </div>
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="service">
                  {t("booking_dialog.select_service")}
                </Label>
                <Select
                ...
                >
                  <SelectTrigger>
                    <SelectValue
                      placeholder={t("booking_dialog.choose_service")}
                    />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="timeSlot">
                    {t("booking_dialog.select_time")}
                  </Label>
                  <Select
                    value={bookingForm.timeSlot}
                    onValueChange={(value) =>
                      setBookingForm({ ...bookingForm, timeSlot: value })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue
                        placeholder={t("booking_dialog.choose_time")}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      {bookingForm.date &&
              ...
              <div>
                <Label htmlFor="specialRequests">
                  {t("booking_dialog.special_requests")}
                </Label>
                <Textarea
                  id="specialRequests"
          ...
          <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-gray-600">
                      ({selectedProvider.reviewCount} {t("reviews")})
                    </span>
                  </div>
                  ...
                  <div className="flex gap-4 text-sm text-gray-600">
                    <span>
                      {selectedProvider.experience} {t("years_experience")}
                    </span>
              ...
              {selectedProvider.certifications.length > 0 && (
                <div>
                  <h4 className="font-semibold mb-3">
                    {t("provider_dialog.certifications")}
                  </h4>
