...
export const ClientDashboardResponseSchema = z.object({
  client: z.object({
    ...
    emailVerified: z.boolean(), // Corrigé: boolean au lieu de date
...
export type ClientAnnouncementSummary = z.infer<
  typeof ClientAnnouncementSummarySchema
>;
export type ClientBookingSummary = z.infer<typeof ClientBookingSummarySchema>;
export type ClientStorageBoxSummary = z.infer<
  typeof ClientStorageBoxSummarySchema
>;
export type ClientNotification = z.infer<typeof ClientNotificationSchema>;
export type ClientTutorialProgress = z.infer<
  typeof ClientTutorialProgressSchema
>;
