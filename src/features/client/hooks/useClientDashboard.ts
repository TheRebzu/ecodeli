  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setData({
        ...
        recentAnnouncements: (dashboardData.recentAnnouncements || []).map(
          (ann: any) => ({
            id: ann.id,
            title: ann.title,
            type: ann.type,
        ...
        activeServices: (dashboardData.recentBookings || []).map(
          (booking: any) => ({
            id: booking.id,
        ...
        storageBoxes: (dashboardData.activeStorageBoxes || []).map(
          (box: any) => ({
            id: box.id,
        ...
        notifications: (dashboardData.notifications || []).map(
          (notif: any) => ({
            id: notif.id,
