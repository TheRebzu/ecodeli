      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">
                <strong>{t('created')}:</strong> {new Date(dispute.createdAt).toLocaleString()}
              </span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">
                <strong>{t('updated')}:</strong> {new Date(dispute.updatedAt).toLocaleString()}
              </span>
            </div>
        ...
        {dispute.additionalInfo && (
          <div>
            ...
            <p className="text-muted-foreground text-sm">{dispute.additionalInfo}</p>
          </div>
        )}
