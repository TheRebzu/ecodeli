    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button 
            onClick={() => loadStats(parseInt(selectedMonth), parseInt(selectedYear))}
            variant="outline"
            size="sm"
          >
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{stats.generatedInvoices}</div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Alert>
                ...
                <AlertDescription>
                  La commission EcoDeli de 15% est automatiquement déduite du montant brut.
                  Les prestataires auto-entrepreneurs ne sont pas soumis à la TVA.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
        ...
        <TabsContent value="manual" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Lancer la facturation pour un mois spécifique (tests et rattrapages)
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  Attention : Cette action va générer les factures pour tous les prestataires
                  ayant des prestations terminées pour la période sélectionnée.
                </AlertDescription>
              </Alert>
              ...
              <div className="flex items-center gap-4">
                ...
                <Button 
                  onClick={() => triggerBilling(parseInt(selectedMonth), parseInt(selectedYear))}
            ...
            <CardContent>
              {lastResults.length === 0 ? (
                <div className="text-center py-8 text-gray-500">
                  Aucun résultat disponible. Lancez une facturation pour voir les résultats.
                </div>
              ) : (
