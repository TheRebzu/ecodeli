  ...
  const loadStats = async () => {
    try {
      ...
      const response = await fetch(
        `/api/admin/billing/monthly-invoices?month=${selectedMonth}&year=${selectedYear}`,
      );
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Sélectionnez la période pour laquelle vous souhaitez consulter ou
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                à 23h00 pour la période écoulée.
              </p>
            </div>
            ...
            <Alert>
              ...
              <AlertDescription>
                Configuration cron requise: <code>0 23 30 * *</code> sur l'URL{" "}
                <code>/api/cron/monthly-billing</code>
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
            ...
            {stats && (
              <>
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                  ...
                  <Badge variant="outline">
                    {stats.totalInvoices > 0
                      ? Math.round(
                          (stats.generatedInvoices / stats.totalInvoices) * 100,
                        )
                      : 0}
                    %
                  </Badge>
                ...
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                  ...
                  <span className="font-semibold">
                    {stats.generatedInvoices > 0
                      ? formatCurrency(
                          stats.totalAmount / stats.generatedInvoices,
                        )
                      : formatCurrency(0)}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center p-3 bg-green-50 rounded">
                  <span className="text-sm font-medium">
                    Montant versé aux prestataires
                  </span>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Gérez la facturation mensuelle et supervisez le processus
            automatique
          </CardDescription>
        </CardHeader>
        <CardContent>
