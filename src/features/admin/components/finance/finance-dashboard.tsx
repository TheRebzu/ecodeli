  ...
  const fetchFinancialData = async () => {
    ...
    try {
      const response = await fetch(
        `/api/admin/finance?period=${selectedPeriod}`,
      );
      if (response.ok) {
            ...
            <DialogContent>
              ...
              <div className="space-y-4">
                <p className="text-sm text-gray-600">
                  Cette action va générer automatiquement toutes les factures
                  mensuelles pour les prestataires et effectuer les virements
                  bancaires.
                </p>
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-semibold">
                  {stats.deliveryStats.total}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Terminées</span>
                <span className="font-semibold text-green-600">
                  {stats.deliveryStats.completed}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Revenus</span>
                <span className="font-semibold">
                  {stats.deliveryStats.revenue.toLocaleString()}€
                </span>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between">
                <span>Total</span>
                <span className="font-semibold">
                  {stats.providerStats.total}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Actifs</span>
                <span className="font-semibold text-green-600">
                  {stats.providerStats.active}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Payé</span>
                <span className="font-semibold text-red-600">
                  -{stats.providerStats.totalPaid.toLocaleString()}€
                </span>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between">
                <span>Total</span>
                <span className="font-semibold">
                  {stats.merchantStats.total}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Actifs</span>
                <span className="font-semibold text-green-600">
                  {stats.merchantStats.active}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Frais collectés</span>
                <span className="font-semibold text-green-600">
                  {stats.merchantStats.totalFees.toLocaleString()}€
                </span>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span>Actifs</span>
                <span className="font-semibold text-green-600">
                  {stats.clientStats.active}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Dépense moyenne</span>
                <span className="font-semibold">
                  {stats.clientStats.averageSpending.toFixed(2)}€
                </span>
              </div>
            </div>
          </CardContent>
              ...
              {revenueData.map((period) => (
                <TableRow key={period.period}>
                  ...
                  <TableCell className="text-green-600">
                    +{period.deliveryCommissions.toLocaleString()}€
                  </TableCell>
                  <TableCell className="text-blue-600">
                    +{period.merchantFees.toLocaleString()}€
                  </TableCell>
                  <TableCell className="text-red-600">
                    -{period.providerPayments.toLocaleString()}€
                  </TableCell>
