      ...
      const response = await fetch("/api/admin/contracts", {
        ...
        body: JSON.stringify({
          ...
          customTerms: {
            ...
            deliveryZones: (formData.get("deliveryZones") as string)
              .split(",")
              .map((z) => z.trim()),
  ...
  const handleContractAction = async (formData: FormData) => {
    ...
    try {
      const response = await fetch(
        `/api/admin/contracts/${selectedContract.id}?action=${actionType}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Gérez les contrats avec les commerçants partenaires
          </p>
        </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <br />
                        {contract.merchant.user.profile.firstName}{" "}
                        {contract.merchant.user.profile.lastName}
                      </div>
                    </div>
                  </div>
                    ...
                    {contract.status === "ACTIVE" && (
                      <>
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            openActionDialog(contract, "terminate")
                          }
                        >
