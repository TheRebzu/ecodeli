    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Paramètres régionaux et monétaires</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("maxDeliveriesPerDay", parseInt(e.target.value))
                }
                min="1"
                max="20"
              />
            ...
            <div>
              <Label htmlFor="maxUsersPerWarehouse">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("maxUsersPerWarehouse", parseInt(e.target.value))
                }
                min="10"
                max="1000"
              />
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("enableTutorial", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("enableReferralProgram", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("enableInsurance", checked)
                }
              />
            </div>
