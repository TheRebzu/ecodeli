  ...
  const handleNotificationTypeChange = (
    ...
    setSettings((prev) => ({
      ...
      notificationTypes: {
        ...
        [type]: {
          ...prev.notificationTypes[
            type as keyof typeof prev.notificationTypes
          ],
          [field]: value,
        },
      },
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description:
            result.error || "Erreur lors du test de la configuration SMTP.",
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      toast({
        ...
        description:
          "Impossible de contacter le serveur pour tester la configuration SMTP.",
        variant: "destructive",
      });
    } finally {
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                handleChange("onesignalEnabled", checked)
              }
            />
          </div>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleChange("onesignalAppId", e.target.value)
                    }
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleChange("onesignalApiKey", e.target.value)
                    }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleChange("onesignalRestApiKey", e.target.value)
                  }
            ...
            <div key={type} className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleNotificationTypeChange(type, "enabled", checked)
                  }
                />
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pl-4">
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleNotificationTypeChange(type, "email", checked)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      checked={config.push}
                      onCheckedChange={(checked) =>
                        handleNotificationTypeChange(type, "push", checked)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      checked={config.sms}
                      onCheckedChange={(checked) =>
                        handleNotificationTypeChange(type, "sms", checked)
                      }
                    />
        ...
        <>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Paramètres pour l'envoi d'emails via SMTP. Configurez votre
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  />
                  <p className="text-sm text-muted-foreground mt-1">
                    Port SMTP (587 pour STARTTLS, 465 pour SSL, 25 pour non
                    sécurisé)
                  </p>
                </div>
              </div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>
                    • <strong>Gmail:</strong> smtp.gmail.com, port 587, STARTTLS
                    activé
                  </li>
                  <li>
                  ...
                  <li>
                    • <strong>OVH:</strong> ssl0.ovh.net, port 465, SSL activé
                  </li>
                  <li>
                    • <strong>Serveur local:</strong> Vérifiez avec votre
                    administrateur
                  </li>
                </ul>
              </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Paramètres pour l'envoi de SMS</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
            ...
            <div key={template} className="space-y-3">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleNestedChange("templates", template, {
                      ...content,
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleNestedChange("quietHours", "start", e.target.value)
                }
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleNestedChange("quietHours", "end", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div>
            <Label htmlFor="maxNotificationsPerDay">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("maxNotificationsPerDay", parseInt(e.target.value))
              }
              min="1"
              max="50"
            />
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                handleChange("enableRichNotifications", checked)
              }
            />
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Suivi et analyse des performances</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("enableNotificationAnalytics", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("trackOpenRates", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("trackClickRates", checked)
                }
              />
            </div>
          </div>
