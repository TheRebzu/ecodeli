...
export function PaymentSettings({ onSettingsChange }: PaymentSettingsProps) {
  const [settings, setSettings] = useState({
    ...
    subscriptionPlans: {
      ...
      STARTER: { price: 9.9, name: "Starter" },
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                handleChange("stripeEnabled", checked)
              }
            />
          </div>
            ...
            <>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleChange("stripeWebhookSecret", e.target.value)
                  }
                  placeholder="whsec_..."
                  type="password"
                />
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleChange("stripeCurrency", value)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleNestedChange("subscriptionPlans", "FREE", {
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleNestedChange("subscriptionPlans", "STARTER", {
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleNestedChange("subscriptionPlans", "PREMIUM", {
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <Label htmlFor="cartDropCommission">
                Commission lâcher chariot
              </Label>
              <div className="relative">
                <Input
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("enableAutoPayments", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("enableRefunds", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("enablePartialRefunds", checked)
                }
              />
            </div>
          </div>
          ...
          <div>
            <Label htmlFor="refundWindowDays">
              Fenêtre de remboursement (jours)
            </Label>
            <Input
              id="refundWindowDays"
              type="number"
              ...
              onChange={(e) =>
                handleChange("refundWindowDays", parseInt(e.target.value))
              }
              min="1"
              max="90"
            />
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("enable3DSecure", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("requireCVV", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("enableFraudDetection", checked)
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("enablePaymentNotifications", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleChange("enableFailedPaymentAlerts", checked)
                }
              />
            </div>
          </div>
