            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {stats.financial.monthlyRevenue.toLocaleString()}€
                </p>
                <p className="text-xs text-muted-foreground">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-20 h-2 bg-gray-200 rounded">
                    <div
                      ...
                      style={{
                        width: `${(stats.users.clients / stats.users.total) * 100}%`,
                      }}
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-20 h-2 bg-gray-200 rounded">
                    <div
                      ...
                      style={{
                        width: `${(stats.users.deliverers / stats.users.total) * 100}%`,
                      }}
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-20 h-2 bg-gray-200 rounded">
                    <div
                      ...
                      style={{
                        width: `${(stats.users.merchants / stats.users.total) * 100}%`,
                      }}
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-20 h-2 bg-gray-200 rounded">
                    <div
                      ...
                      style={{
                        width: `${(stats.users.providers / stats.users.total) * 100}%`,
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="pt-2 border-t">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-2xl">
                    {(
                      stats.financial.monthlyRevenue -
