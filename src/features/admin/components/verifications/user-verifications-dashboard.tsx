...
export function UserVerificationsDashboard({
  ...
  const filteredUsers = users.filter((user) => {
    ...
    if (selectedStatus !== "all" && user.verificationStatus !== selectedStatus)
      return false;
    return true;
  });
...
function UserVerificationsTable({
  users,
  getStatusBadge,
  getRoleBadge,
              ...
              <TableRow key={user.id}>
                <TableCell>
                  <div className="flex flex-col">
                    ...
                    {!user.emailVerified && (
                      <Badge
                        variant="outline"
                        className="text-xs w-fit mt-1 text-orange-600"
                      >
                        Email non vérifié
                      </Badge>
                    )}
                ...
                <TableCell>
                  <div className="flex flex-col space-y-1">
                    <div className="text-sm">Total: {user.documentsCount}</div>
                ...
                <TableCell>
                  {user.lastDocumentSubmitted ? (
                    <div className="text-sm">
                      {formatDistanceToNow(
                        new Date(user.lastDocumentSubmitted),
                        {
                          addSuffix: true,
                          locale: fr,
                        },
                ...
                <TableCell>
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `/admin/documents/validation?userId=${user.id}`,
                          "_blank",
                        )
                      }
                    >
