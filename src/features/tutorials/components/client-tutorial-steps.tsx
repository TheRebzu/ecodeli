...
const TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    content: 'EcoDeli vous permet de créer des annonces pour vos livraisons et de réserver des services à la personne. Notre réseau de livreurs et prestataires vous garantit un service de qualité.'
  },
  {
    id: 'announcements',
    title: 'Créer une annonce',
    description: 'Publiez vos demandes de livraison',
    content: 'Créez des annonces pour vos colis, courses ou déménagements. Nos livreurs recevront une notification et pourront accepter votre demande.',
    action: {
  ...
  },
  {
    ...
    content: 'Réservez des services comme le ménage, le jardinage, la garde d\'animaux avec nos prestataires vérifiés.',
    action: {
  ...
  },
  {
    ...
    content: 'Passez à un abonnement Starter (9€/mois) ou Premium (19€/mois) pour plus d\'annonces et de services prioritaires.',
    action: {
...
export function ClientTutorialSteps({ onComplete, onSkip }: ClientTutorialStepsProps) {
