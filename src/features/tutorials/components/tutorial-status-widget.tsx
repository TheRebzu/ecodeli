        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span>
                {progress?.completedSteps || 0}/{progress?.totalSteps || 5}{" "}
                étapes
              </span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span>
                {progress?.completedMandatory || 0}/
                {progress?.mandatorySteps || 4} obligatoires
              </span>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            <Button onClick={openTutorial} className="flex-1" size="sm">
              <BookOpen className="w-4 h-4 mr-2" />
          ...
          {tutorialState.tutorialRequired && (
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 mt-3">
              <p className="text-xs text-orange-800">
                ⚠️ Le tutoriel est obligatoire pour accéder à toutes les
                fonctionnalités
              </p>
            </div>
          )}
