...
export function useContractNegotiations(initialFilters: Partial<NegotiationFilters> = {}) {
  ...
  const rejectProposalMutation = api.admin.contracts.rejectNegotiationProposal.useMutation({
    onSuccess: () => {
      toast({
  ...
  const makeCounterProposalMutation = api.admin.contracts.makeCounterProposal.useMutation({
    onSuccess: () => {
      toast({
  ...
  const completeNegotiationMutation = api.admin.contracts.completeNegotiation.useMutation({
    onSuccess: () => {
      toast({
  ...
  const cancelNegotiationMutation = api.admin.contracts.cancelNegotiation.useMutation({
    onSuccess: () => {
      toast({
  ...
  const completeNegotiation = async (negotiationId: string, finalTerms: any) => {
