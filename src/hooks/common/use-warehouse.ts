...
export const useWarehouse = () => {
  ...
  const updateWarehouseMutation =
    api.adminWarehouse.updateWarehouse.useMutation();
  ...
  const updateReservationMutation =
    api.adminWarehouse.updateReservation.useMutation();
  const cancelReservationMutation =
    api.adminWarehouse.cancelReservation.useMutation();
