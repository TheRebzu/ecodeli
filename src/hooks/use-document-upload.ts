...
export function useDocumentUpload() {
  ...
  const uploadFile = async (file: File, type: DocumentType, expiryDate?: Date) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : "Erreur lors de l'upload du document";
  ...
  const uploadAllFiles = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : "Erreur lors de l'upload des documents";
      setError(errorMessage);
      toast({
        title: "Erreur",
        description: errorMessage,
