      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            {t("auth.register.deliverer.subtitle") ||
        ...
        <div className="bg-blue-50 rounded-lg p-4 mb-6">
          <h3 className="font-medium text-blue-900 mb-2">
            {t("auth.register.deliverer.advantagesTitle") ||
              "Pourquoi devenir livreur ?"}
          </h3>
          <ul className="space-y-1 text-sm text-blue-800">
            <li>
              💰{" "}
              {t("auth.register.deliverer.advantage1") ||
                "Revenus complémentaires flexibles"}
            </li>
            <li>
              🗺️{" "}
              {t("auth.register.deliverer.advantage2") ||
                "Rentabilisez vos trajets quotidiens"}
            </li>
            <li>
              ⏰{" "}
              {t("auth.register.deliverer.advantage3") ||
                "Liberté totale de vos horaires"}
            </li>
            <li>
              🌱{" "}
              {t("auth.register.deliverer.advantage4") ||
