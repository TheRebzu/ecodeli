      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            {t("auth.register.merchant.subtitle") ||
        ...
        <div className="bg-purple-50 rounded-lg p-4 mb-6">
          <h3 className="font-medium text-purple-900 mb-2">
            {t("auth.register.merchant.advantagesTitle") ||
              "Avantages commerçant"}
          </h3>
          <ul className="space-y-1 text-sm text-purple-800">
            <li>
              📈{" "}
              {t("auth.register.merchant.advantage1") ||
                "Augmentez vos ventes en ligne"}
            </li>
            <li>
              🛒{" "}
              {t("auth.register.merchant.advantage2") ||
                "Service de lâcher de chariot"}
            </li>
            <li>
              📊{" "}
              {t("auth.register.merchant.advantage3") ||
                "Analytics et rapports détaillés"}
            </li>
            <li>
              🤝{" "}
              {t("auth.register.merchant.advantage4") ||
        ...
        <div className="mt-6 text-center space-y-4">
          ...
          >
            {t("auth.register.chooseAnotherAccountType") ||
