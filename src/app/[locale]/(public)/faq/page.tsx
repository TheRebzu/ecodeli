            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="relative w-full max-w-md mx-auto">
                ...
                <Input
                  ...
                  placeholder={
                    t("searchPlaceholder") || "Rechercher dans la FAQ..."
                  }
                  type="search"
                />
              </div>
                ...
                <div className="sticky top-20">
                  ...
                  <div className="flex flex-col space-y-1">
                    {[
                      ...
                      t("categories.account") || "Inscription et compte",
                    ].map((category, i) => (
                      <a
                        key={i}
                ...
                <div id="annonces-et-trajets">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    {[
                      ...
                      {
                        question:
                          t("announcements.q2.question") ||
                          "Puis-je modifier ou annuler mon annonce ?",
                        answer: t(
                          "announcements.q2.answer",
                      ...
                      {
                        question:
                          t("announcements.q3.question") ||
                          "Comment rechercher des trajets disponibles ?",
                        answer: t(
                          "announcements.q3.answer",
                ...
                <div id="sécurité-et-garanties">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    {[
                      {
                        question:
                          t("security.q1.question") ||
                          "Comment les colis sont-ils assurés ?",
                        answer: t(
                          "security.q1.answer",
                      ...
                      {
                        question:
                          t("security.q2.question") ||
                          "Comment sont vérifiés les livreurs ?",
                        answer:
                          t("security.q2.answer") ||
                ...
                <div id="inscription-et-compte">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    {[
                      {
                        question:
                          t("account.q1.question") ||
                          "Comment créer un compte sur EcoDeli ?",
                        answer: t(
                          "account.q1.answer",
                      ...
                      {
                        question:
                          t("account.q3.question") ||
                          "Comment devenir livreur sur EcoDeli ?",
                        answer: t(
                          "account.q3.answer",
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button asChild variant="default">
                  <Link href="/contact">
                    {t("notFound.contactUs") || "Contactez-nous"}
                  </Link>
                </Button>
