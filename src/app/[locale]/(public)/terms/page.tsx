        ...
        <CardContent className="space-y-6">
          <section>
            ...
            <p className="text-muted-foreground">
              Les présentes conditions générales d'utilisation (CGU) définissent les règles d'utilisation de la plateforme EcoDeli, 
              service de livraison écologique et de mise en relation entre clients, livreurs, marchands et prestataires de services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              L'inscription nécessite de fournir des informations exactes et à jour. 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Chaque utilisateur est responsable de l'utilisation qu'il fait de la plateforme et doit respecter 
              la législation en vigueur ainsi que les droits des tiers.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              <a href="mailto:contact@ecodeli.com" className="text-primary hover:underline ml-1">
                contact@ecodeli.com
              </a>
            </p>
          </section>
