    ...
    <div className="flex flex-col gap-16 pb-20 max-w-screen-2xl mx-auto">
            ...
            {[
              {
                icon: Leaf,
                title: t(
                  "missionItems.reduceImpact.title",
                  "Réduire l'impact environnemental",
                ),
                description:
                  t("missionItems.reduceImpact.description") ||
              ...
              },
              {
                icon: Users,
                title: t(
                  "missionItems.createPurchasingPower.title",
                  "Créer du pouvoir d'achat",
                ),
                description:
                  t("missionItems.createPurchasingPower.description") ||
              ...
              },
              {
                icon: Shield,
                title: t(
                  "missionItems.fightIsolation.title",
                  "Lutter contre l'isolement",
                ),
                description: t(
                  "missionItems.fightIsolation.description",
              ...
              },
              {
                icon: Recycle,
                title:
                  t("missionItems.optimizeResources.title") ||
                  "Optimiser les ressources",
                description: t(
                  "missionItems.optimizeResources.description",
              ...
              },
              {
                icon: Award,
                title:
                  t("missionItems.offerVariedServices.title") ||
                  "Proposer des services variés",
                description:
                  t("missionItems.offerVariedServices.description") ||
                  "Au-delà du transport de colis, nous proposons divers services à la personne pour répondre à tous les besoins.",
              },
              {
                icon: Heart,
                title: t(
                  "missionItems.supportLocalEconomy.title",
                  "Soutenir l'économie locale",
                ),
                description:
                  t("missionItems.supportLocalEconomy.description") ||
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <div className="bg-muted/30 rounded-xl p-8">
              <h3 className="text-2xl font-bold mb-4">
                {t("parcelTransport.title") || "Transport de colis"}
              </h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <span className="mr-2 text-primary">•</span>
                  <span>
                    {t("parcelTransport.item1") ||
                ...
                <li className="flex items-start">
                  <span className="mr-2 text-primary">•</span>
                  <span>
                    {t("parcelTransport.item5") ||
                      "Assurances pour les colis transportés"}
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2 text-primary">•</span>
                  <span>
                    {t("parcelTransport.item6") ||
                      "Système de validation par code de confirmation"}
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-muted/30 rounded-xl p-8">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <span className="mr-2 text-primary">•</span>
                  <span>
                    {t("personalServices.item3") ||
                      "Services de courses selon liste fournie"}
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2 text-primary">•</span>
      ...
      <section className="w-full bg-muted/30 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <Badge className="mb-4">
              {t("howItWorksBadge") || "Comment ça marche"}
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
            ...
            {[
              {
                number: "01",
                title: t(
                  "howItWorksItems.publish.title",
                  "Publication d'annonces",
                ),
                description: t(
                  "howItWorksItems.publish.description",
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button size="lg" variant="outline" asChild>
                  <Link href="/services">
                    {t("cta.discoverServices") || "Découvrir nos services"}
                  </Link>
                </Button>
              </div>
            </div>
