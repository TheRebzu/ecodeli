      ...
      <main className="flex-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  ...
                  <Button size="lg" asChild>
                    ...
                    <Link href="/register?as=courier">
                      {" "}
                      {t("registerAsCourier", "S'inscrire comme livreur")}{" "}
                    </Link>{" "}
                  </Button>{" "}
                  <Button size="lg" variant="outline" asChild>
                    {" "}
                    <Link href="#avantages">
                      {t("discoverAdvantages") || "Découvrir les avantages"}
                    </Link>{" "}
                  </Button>{" "}
                </div>{" "}
              </div>{" "}
                ...
                <div className="aspect-square max-w-lg mx-auto">
                  ...
                  <div className="absolute inset-0 rounded-xl overflow-hidden">
                    ...
                    <Image
                      ...
                      alt={t("heroImageAlt") || "Livreur EcoDeli à vélo"}
        ...
        <section id="avantages" className="w-full py-16 md:py-24">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="flex flex-col items-center text-center space-y-4 mb-12 md:mb-16">
              {" "}
              <Badge>{t("advantagesBadge") || "Les avantages"}</Badge>{" "}
              ...
              {[
                {
                  icon: Coins,
                  title: t(
                    "advantages.purchasingPower.title",
                    "Pouvoir d'achat",
                  ),
                  description:
                    t("advantages.purchasingPower.description") ||
                ...
                },
                {
                  icon: Clock,
                  title:
                    t("advantages.flexibility.title") || "Flexibilité totale",
                  description:
                ...
                },
                {
                  icon: Leaf,
                  title:
                    t("advantages.ecologicalImpact.title") ||
                    "Impact écologique",
                  description: t(
                    "advantages.ecologicalImpact.description",
                ...
                {
                  icon: ShieldCheck,
                  title: t("advantages.security.title") || "Sécurité assurée",
                  description:
                ...
                },
                {
                  icon: Users,
                  title: t(
                    "advantages.fightIsolation.title",
                    "Lutte contre l'isolement",
                  ),
                  description:
                    t("advantages.fightIsolation.description") ||
                ...
                },
                {
                  icon: HandHeart,
                  title:
                    t("advantages.variedServices.title") || "Services variés",
                  description: t(
                    "advantages.variedServices.description",
        ...
        <section className="w-full py-16 md:py-24 bg-muted/30">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="flex flex-col items-center text-center space-y-4 mb-12 md:mb-16">
              {" "}
              <Badge>{t("processBadge") || "Le processus"}</Badge>{" "}
              <h2 className="text-3xl md:text-4xl font-bold tracking-tighter">
                {" "}
                {t("processTitle") || "Comment devenir livreur"}{" "}
              </h2>{" "}
              <p className="text-muted-foreground max-w-[700px]">
                {" "}
                {t("processSubtitle") ||
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              {[
                {
                  number: "01",
                  title: t("processSteps.register.title") || "Inscription",
                  description:
                    t("processSteps.register.description") ||
                    "Créez votre compte sur notre site et complétez votre profil avec vos informations personnelles.",
                },
                {
                  number: "02",
                  title: t("processSteps.verification.title") || "Vérification",
                  description:
                    t("processSteps.verification.description") ||
                    "Fournissez les pièces justificatives demandées pour la validation de votre compte par EcoDeli.",
                },
                {
                  number: "03",
                  title: t("processSteps.announcements.title") || "Annonces",
                  description: t(
                    "processSteps.announcements.description",
                ...
                },
                {
                  number: "04",
                  title:
                    t("processSteps.deliveryPayment.title") ||
                    "Livraison et paiement",
                  description:
                    t("processSteps.deliveryPayment.description") ||
            ...
            <div className="flex justify-center mt-12">
              ...
              <Button size="lg" asChild>
                ...
                <Link href="/register?as=courier">
                  {" "}
                  {t("becomeCourierNow") || "Devenir livreur maintenant"}{" "}
                </Link>{" "}
              </Button>{" "}
            </div>{" "}
          </div>{" "}
        ...
        <section className="w-full py-16 md:py-24">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="flex flex-col items-center text-center space-y-4 mb-12 md:mb-16">
              {" "}
              <Badge>{t("servicesBadge") || "Nos services"}</Badge>{" "}
              <h2 className="text-3xl md:text-4xl font-bold tracking-tighter">
                {" "}
                {t("servicesTitle") ||
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {[
                {
                  title: t("parcelTransport.title") || "Transport de colis",
                  features: [
                    t("parcelTransport.feature1") ||
                      "Livraison de colis de particuliers à particuliers",
                    t("parcelTransport.feature2") ||
                      "Prise en charge intégrale ou partielle du trajet",
                    t("parcelTransport.feature3") ||
                      "Livraison aux destinataires finaux",
                    t("parcelTransport.feature4") || "Suivi en temps réel",
                    t("parcelTransport.feature5") ||
        ...
        <section className="w-full py-16 md:py-24 bg-muted/30">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="flex flex-col items-center text-center space-y-4 mb-12">
              {" "}
              <Badge>{t("paymentBadge") || "Paiement"}</Badge>{" "}
              <h2 className="text-3xl md:text-4xl font-bold tracking-tighter">
                {" "}
                {t("paymentTitle") || "Comment êtes-vous payé ?"}{" "}
              </h2>{" "}
              <p className="text-muted-foreground max-w-[700px]">
                {" "}
                {t("paymentSubtitle") ||
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <p>
                      ...
                      {t(
                        "paymentSteps.step3",
                        "Le jour de la livraison, le destinataire communique un code. Vous validez la livraison en saisissant ce code sur la page de discussion ou l'annonceur confirme la livraison directement depuis son compte EcoDeli.",
                      )}{" "}
                    </p>{" "}
                  </div>{" "}
                  <div className="flex items-start">
                    ...
                    <p>
                      ...
                      {t(
                        "paymentSteps.step4",
                        'L\'argent est immédiatement disponible dans votre portefeuille EcoDeli. Le paiement se trouve dans la rubrique "Mes paiements" de votre compte.',
                      )}{" "}
                    </p>{" "}
                  </div>{" "}
                  <div className="flex items-start">
                    ...
                    <p>
                      {" "}
                      {t("paymentSteps.step5") ||
                        "Vous pouvez demander un virement sur votre compte bancaire à tout moment."}{" "}
                    </p>{" "}
                  </div>{" "}
                </div>{" "}
              </Card>{" "}
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="max-w-4xl mx-auto bg-muted rounded-xl p-8 md:p-12 border shadow-sm">
              ...
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <h2 className="text-3xl md:text-4xl font-bold tracking-tighter">
                  {" "}
                  {t("cta.title") || "Prêt à devenir livreur EcoDeli ?"}{" "}
                </h2>{" "}
