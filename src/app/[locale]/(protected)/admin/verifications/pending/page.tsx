...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      "Liste des utilisateurs avec des documents en attente de vérification",
  };
}
...
export default async function PendingVerificationsPage({
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Vérifications en attente</h1>
        <p className="text-muted-foreground">
          Documents en attente de validation des livreurs, prestataires et
          commerçants
        </p>
      </div>
