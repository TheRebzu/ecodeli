    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{(referralStats.conversionRate * 100).toFixed(1)}%</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{referralStats.influencers}</div>
            <p className="text-xs text-muted-foreground">
                  ...
                  <div key={program.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        {program.successfulReferrals}/{program.totalReferrals} réussis • 
                        Taux: {(program.conversionRate * 100).toFixed(0)}%
                      </p>
                  ...
                  <div key={referrer.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {referrer.role} • {referrer.successfulReferrals}/{referrer.totalReferrals} réussis
                        </p>
                        <p className="text-xs text-muted-foreground">
                          Dernier parrainage: {new Date(referrer.lastReferral).toLocaleDateString('fr-FR')}
                        </p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="font-semibold text-green-600">{referrer.totalRewards}€</p>
              ...
              <div className="space-y-4">
                {influencerPrograms.map((influencer) => (
                  <div key={influencer.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <h3 className="font-medium">{influencer.influencerName}</h3>
                      ...
                      <div className="flex items-center gap-4 text-xs text-muted-foreground">
                        ...
                        <span>Conversion: {(influencer.conversionRate * 100).toFixed(1)}%</span>
                      </div>
                    </div>
                    <div className="text-right space-y-1">
                      <div className="flex gap-4 text-sm">
                        <div>
                          <p className="font-medium">{influencer.totalClicks}</p>
                        ...
                        <div>
                          <p className="font-medium text-green-600">{influencer.totalEarnings}€</p>
