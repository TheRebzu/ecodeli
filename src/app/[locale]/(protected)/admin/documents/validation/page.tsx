...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      "Interface de validation des documents soumis par les utilisateurs",
  };
}
...
export default async function DocumentValidationPage({
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Validation des documents</h1>
        <p className="text-muted-foreground">
          Gérez et validez les documents soumis par les livreurs, prestataires
          et commerçants
        </p>
      </div>
