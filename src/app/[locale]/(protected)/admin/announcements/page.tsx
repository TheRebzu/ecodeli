                    ...
                    <TableCell>
                      <Select
                        ...
                        onValueChange={(newStatus) =>
                          handleStatusChange(announcement.id, newStatus)
                        }
                      >
                            ...
                            <div className="space-y-4">
                              ...
                              {announcement.packageDetails && (
                                <div>
                                  ...
                                  <p className="text-sm">
                                    Poids: {announcement.packageDetails.weight}
                                    kg - Dimensions:{" "}
        ...
        <div className="flex justify-center gap-2">
          ...
          <div className="flex items-center gap-1">
            {Array.from({ length: Math.min(7, totalPages) }, (_, i) => {
              const pageNum =
                Math.max(1, Math.min(totalPages - 6, page - 3)) + i;
              return (
                <Button
                  key={pageNum}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p>
                    {format(
                      new Date(selectedAnnouncement.desiredDate),
                      "dd/MM/yyyy à HH:mm",
                      { locale: fr },
                    )}
                  </p>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() =>
                selectedAnnouncement && handleDelete(selectedAnnouncement.id)
              }
              className="bg-red-600 hover:bg-red-700"
              disabled={!!deletingId}
            >
