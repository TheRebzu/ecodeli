      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <span>
              {announcement.basePrice?.toFixed(2)} {announcement.currency}
            </span>
          </div>
          <div className="flex items-center gap-2 mb-2">
        ...
        <div className="flex gap-2 mt-4">
          <Button
            variant="outline"
            onClick={() => onModerate(announcement.id, "APPROVE")}
          >
            Approuver
          </Button>
          <Button
            variant="outline"
            onClick={() => onModerate(announcement.id, "SUSPEND")}
          >
            Suspendre
          </Button>
          <Button
            variant="outline"
            onClick={() => onModerate(announcement.id, "FLAG")}
          >
            Signaler
          </Button>
          <Button
