...
const faqData: FAQItem[] = [
  {
    ...
    answer:
      'Rendez-vous dans la section "Suivi en temps réel" de votre tableau de bord. Vous pourrez voir la position GPS de votre livreur et recevoir des notifications push.',
    isPopular: true,
    helpfulCount: 127,
  },
  {
    ...
    answer:
      "Nous acceptons les cartes bancaires (Visa, Mastercard), PayPal, et les virements SEPA. Tous les paiements sont sécurisés par Stripe.",
    isPopular: true,
    helpfulCount: 89,
  },
  {
    ...
    answer:
      'Allez dans "Services", choisissez votre catégorie, sélectionnez un prestataire et réservez un créneau. Vous recevrez une confirmation par email.',
    isPopular: false,
    helpfulCount: 45,
  },
  {
    ...
    answer:
      'Dans la section "Stockage", consultez les box disponibles près de chez vous, choisissez la taille adaptée et procédez à la réservation.',
    isPopular: false,
    helpfulCount: 32,
  },
  {
    ...
    answer:
      'Allez dans "Mon Profil", cliquez sur "Modifier" et mettez à jour vos informations. N\'oubliez pas de sauvegarder.',
    isPopular: true,
    helpfulCount: 156,
  },
];
                    ...
                    {expandedFAQ === item.id && (
                      <div className="mt-3 pt-3 border-t">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-500">
                          <span>
                            👍 {item.helpfulCount} personnes ont trouvé cela
                            utile
                          </span>
                ...
                <div key={item.id} className="border rounded-lg p-4">
                  ...
                  {expandedFAQ === item.id && (
                    <div className="mt-3 pt-3 border-t">
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-500">
                        <span>
                          👍 {item.helpfulCount} personnes ont trouvé cela utile
                        </span>
                        <Badge variant="secondary">{item.category}</Badge>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  "Tutorial complet pour publier votre première demande",
                icon: "📦",
              ...
              },
              {
                ...
                description:
                  "Protéger vos données et utiliser EcoDeli en sécurité",
                icon: "🔒",
