...
export default function ServiceRequestDetailPage() {
  ...
  const handleDelete = async () => {
    if (
      !serviceRequest ||
      !confirm("Êtes-vous sûr de vouloir supprimer cette demande de service ?")
    ) {
      return;
    }
    ...
    try {
      const response = await fetch(
        `/api/client/service-requests/${serviceRequest.id}`,
        {
          method: "DELETE",
        },
      );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Demande #{serviceRequest.id.slice(-8)}
              </p>
            </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-gray-900">
                            {getServiceTypeLabel(
                              serviceRequest.serviceDetails.serviceType,
                            )}
                          </p>
                        </div>
                        ...
                        {serviceRequest.serviceDetails.recurringService && (
                          <div>
                            ...
                            <p className="text-gray-900">
                              {serviceRequest.serviceDetails.recurringPattern ||
                                "Oui"}
                            </p>
                          </div>
                        )}
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">
                    {serviceRequest.stats.applicationsCount}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Réservations</span>
                  <span className="font-semibold">
                    {serviceRequest.stats.bookingsCount}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Avis</span>
                  <span className="font-semibold">
                    {serviceRequest.stats.reviewsCount}
                  </span>
                </div>
              </CardContent>
            </Card>
