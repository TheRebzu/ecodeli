      ...
      <Tabs defaultValue="all" className="space-y-6">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="services">
            Services ({reviews.filter(r => r.serviceType === 'service').length})
          </TabsTrigger>
        </TabsList>
    ...
    return (
      <Card>
        <CardContent className="text-center py-12">
          ...
          <p className="text-gray-600">Utilisez nos services pour pouvoir les évaluer</p>
        </CardContent>
      </Card>
    )
  }
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <h4 className="font-semibold text-lg">{review.serviceName}</h4>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {review.status === 'published' ? 'Publié' :
                       review.status === 'pending' ? 'En attente' : 'Signalé'}
                    </Badge>
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500">
                  ...
                  <span className="flex items-center gap-1">
                    ...
                    <span>Il y a {Math.floor((Date.now() - new Date(review.createdAt).getTime()) / (1000 * 60 * 60 * 24))} jours</span>
                  </span>
                </div>
              </div>
            </div>
