        ...
        <CardFooter>
          <div className="flex gap-2 mt-2 w-full">
            <Button variant="outline" size="sm" className="flex-1" asChild>
              <Link
                href={`/[locale]/(protected)/client/services/bookings/${id}`}
              >
            ...
            {status === "PENDING" && (
              ...
              >
                <Link
                  href={`/[locale]/(protected)/client/services/bookings/${id}/cancel`}
                >
                  <X className="h-4 w-4" />
                  {t("manage.cancel")}
                </Link>
            ...
            {status === "CONFIRMED" && (
              ...
              >
                <Link
                  href={`/[locale]/(protected)/client/services/bookings/${id}/reschedule`}
                >
            ...
            {status === "COMPLETED" && !booking.review && (
              ...
              >
                <Link
                  href={`/[locale]/(protected)/client/services/bookings/${id}/review`}
                >
          ...
          <TabsContent value="past">
            {pastBookings.length === 0 ? (
              <div className="text-center py-10">
                <Calendar className="mx-auto h-12 w-12 text-gray-300" />
                <h3 className="mt-2 text-lg font-medium">
                  {t("manage.noPastBookings")}
                </h3>
                <p className="mt-1 text-muted-foreground">
                  {t("manage.noPastBookingsSubtitle")}
                </p>
              </div>
            ) : (
