      ...
      <div className="container py-6 space-y-6">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink as={Link} href="/[locale]/(protected)/client/services">
                {t('list.title')}
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink as={Link} href={`/[locale]/(protected)/client/services/${serviceId}`}>
                {service.name}
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator>
        ...
        <h1 className="text-3xl font-bold tracking-tight">{t('booking.form.title')}</h1>
              ...
              <CardContent>
                ...
                >
                  <BookingForm
                    ...
                    onCancel={() => redirect(`/[locale]/(protected)/client/services/${serviceId}`)}
                  />
                </Suspense>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="font-medium">{t('booking.summary.price')}</h3>
