...
export default function DeliveryPaymentPage() {
  ...
  const { user } = useAuth();
  const [deliveryData, setDeliveryData] = useState<DeliveryPaymentData | null>(null);
  ...
  const fetchDeliveryInfo = async () => {
    try {
      ...
      const response = await fetch(`/api/client/deliveries/${deliveryId}/payment`);
            ...
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <div className="space-x-4">
                  ...
                  <Button onClick={fetchDeliveryInfo}>
                    Réessayer
                  </Button>
                </div>
              </div>
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Confirmez votre paiement pour démarrer la livraison</p>
          </div>
        </div>
        ...
        <Card className="bg-blue-50 border-blue-200">
          <CardContent className="p-4">
            <h4 className="font-semibold text-blue-800 mb-2">🔒 Paiement sécurisé</h4>
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• Votre paiement est retenu en sécurité jusqu'à la livraison</li>
