        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Les virements sont traités dans un délai de 3 à 5 jours ouvrables. Le montant
                minimum est de 10€.
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Les virements sont effectués sur le compte bancaire associé à votre compte Stripe
                  Connect.
                </p>
              </div>
