  ...
  return (
    <div className="container py-6 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">{t('availableAnnouncements')}</h1>
          <p className="text-muted-foreground mt-1">{t('findDeliveryOpportunities')}</p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={activeTab === 'available' ? fetchAvailableAnnouncements : fetchMyApplications}
            ...
            <div className="space-y-4">
              <div className="flex flex-col md:flex-row gap-4 items-end">
                ...
                >
                  ...
                  {isLoadingLocation ? t('searchingLocation') : t('searchNearMe')}
                </Button>
              </div>
            </div>
          </CardContent>
      ...
      <Tabs defaultValue="available" value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="mb-6">
          <TabsTrigger value="available">{t('availableAnnouncements')}</TabsTrigger>
        ...
        <TabsContent value="available" className="space-y-4">
          {isLoading ? (
            ...
            <div className="text-center py-12 bg-muted/50 rounded-lg">
              <h3 className="text-lg font-medium">{t('noAvailableAnnouncements')}</h3>
        ...
        <TabsContent value="applications" className="space-y-4">
          {isLoadingApplications ? (
            ...
            <div className="text-center py-12 bg-muted/50 rounded-lg">
              ...
              <p className="text-muted-foreground mt-2">{t('applyToAnnouncements')}</p>
              <Button variant="outline" onClick={() => setActiveTab('available')} className="mt-4">
