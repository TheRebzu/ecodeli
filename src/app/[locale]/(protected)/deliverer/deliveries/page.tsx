              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="dateAsc">
                    {t("filters.sortByDateAsc")}
                  </SelectItem>
                  <SelectItem value="dateDesc">
                    {t("filters.sortByDateDesc")}
                  </SelectItem>
                  {userLocation && (
                    <SelectItem value="distanceAsc">
      ...
      <Tabs defaultValue="accepted" className="w-full">
        ...
        {["accepted", "active", "completed"].map((tab) => (
          <TabsContent key={tab} value={tab} className="space-y-4 mt-4">
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-muted-foreground mt-2">
                  {t("deliverer.noDeliveriesMessage")}
                </p>
                <Button
                  variant="default"
                  className="mt-4"
                          ...
                          {delivery.status === "ACCEPTED" ? (
                            <Button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                router.push(
                                  `/deliverer/deliveries/active?id=${delivery.id}`,
                                );
                              }}
                            >
            ...
            {tab === "active" &&
              filteredDeliveries.some((d) => d.status === "IN_TRANSIT") && (
