...
import { Plus, Trash2, Clock, MapPin, Settings2, Save, AlertCircle } from 'lucide-react'
...
export default function CartDropSettingsPage() {
  ...
  const removeDeliveryZone = (index: number) => {
    const zones = form.getValues('deliveryZones')
    form.setValue('deliveryZones', zones.filter((_, i) => i !== index))
  }
  ...
  const removeTimeSlot = (index: number) => {
    const slots = form.getValues('timeSlots')
    form.setValue('timeSlots', slots.filter((_, i) => i !== index))
  }
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <Label htmlFor="maxOrdersPerSlot">Commandes max par créneau</Label>
                <Input
                  id="maxOrdersPerSlot"
                  type="number"
                  min={1}
              ...
              <div>
                <Label htmlFor="avgPreparationTime">Temps préparation (min)</Label>
                <Input
                  id="avgPreparationTime"
                  type="number"
                  min={5}
                  max={120}
                  {...form.register('avgPreparationTime', { valueAsNumber: true })}
                />
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            {form.watch('deliveryZones').length === 0 ? (
              ...
              <>
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          min={0}
                          step={0.01}
                          {...form.register(`deliveryZones.${index}.deliveryFee`, { valueAsNumber: true })}
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          min={1}
                          max={50}
                          {...form.register(`deliveryZones.${index}.maxDistance`, { valueAsNumber: true })}
                        />
                      </div>
                    </div>
                    <Button
                ...
                <Button type="button" variant="outline" onClick={addDeliveryZone}>
                  <Plus className="h-4 w-4 mr-2" />
                  Ajouter une zone
                </Button>
              </>
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          {...form.register(`timeSlots.${index}.day`, { valueAsNumber: true })}
                        >
        ...
        <Card className="border-yellow-200 bg-yellow-50">
          <CardContent className="pt-6">
            ...
            <p className="text-yellow-700 mt-1">
              ...
              Activez-le pour permettre aux clients de commander des livraisons à domicile.
            </p>
          </CardContent>
        </Card>
      )}
