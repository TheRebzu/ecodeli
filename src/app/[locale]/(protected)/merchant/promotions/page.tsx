  ...
  const handleUpdatePromotion = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/merchant/promotions/${editingPromotion.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600">
            Gérez vos offres promotionnelles pour attirer plus de clients
          </p>
        </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="RETURNING_CUSTOMERS">
                        Clients fidèles
                      </SelectItem>
      ...
      >
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="upcoming" className="flex items-center gap-2">
            <ClockIcon className="w-4 h-4" />À venir (
            {
              promotions.filter((p) => getPromotionStatus(p) === "upcoming")
                .length
            }
            )
          </TabsTrigger>
          <TabsTrigger value="expired" className="flex items-center gap-2">
            ...
            Expirées (
            {
              promotions.filter(
                (p) =>
                  getPromotionStatus(p) === "expired" ||
                  getPromotionStatus(p) === "inactive",
              ).length
            }
            )
          </TabsTrigger>
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-2">
                            <Switch
                              ...
                              onCheckedChange={(checked) =>
                                handleTogglePromotion(promotion.id, checked)
                              }
                              size="sm"
                            />
                            <Button
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {Math.round(
                    promotions
                      ...
                      promotions.filter((p) => p.type === "PERCENTAGE")
                        .length || 0,
                  )}
                  %
                </p>
