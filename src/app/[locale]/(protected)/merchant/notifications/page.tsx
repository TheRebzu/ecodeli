  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600">
            Gérez vos notifications et paramètres d'alertes
          </p>
        </div>
      ...
      >
        ...
        <TabsContent
          value={selectedTab}
          className={selectedTab === "settings" ? "hidden" : ""}
        >
          <Card>
            <CardHeader>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Recevez les notifications push sur vos appareils
                          </p>
                        </div>
                      </div>
                      <Switch
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Quand vous recevez une nouvelle commande
                        </p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Confirmations de paiement et retraits
                        </p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Performances de vos promotions
                        </p>
                      </div>
                      <Switch
