...
export default function CreateSingleAnnouncementPage() {
  ...
  const type =
    (searchParams.get("type") as keyof typeof ANNOUNCEMENT_TYPES) ||
    "PACKAGE_DELIVERY";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requestData = {
        ...
        maxInsuranceValue: formData.maxInsuranceValue
          ? parseFloat(formData.maxInsuranceValue)
          : undefined,
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <Card className="max-w-md">
          <CardContent className="p-6 text-center">
            ...
            <Button asChild>
              <Link href="/merchant/announcements">Voir mes annonces</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Décrivez clairement votre demande pour attirer les bons
                  livreurs
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {formData.title.length}/200 caractères - Minimum 5, soyez
                    précis et accrocheur
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        handleInputChange("requiresInsurance", !!checked)
                      }
                    />
                    <Label
                      htmlFor="requiresInsurance"
                      className="flex items-center gap-2"
                    >
                  ...
                  {formData.requiresInsurance && (
                    <div className="ml-6 space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("maxInsuranceValue", e.target.value)
                        }
                        placeholder="150.00"
                      />
                    </div>
            ...
            <Card className="bg-blue-50 border-blue-200">
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <div className="flex justify-between text-muted-foreground">
                  ...
                  <span>
                    -{(parseFloat(formData.basePrice || "0") * 0.15).toFixed(2)}{" "}
                    €
                  </span>
                </div>
                {formData.isUrgent && (
                  <div className="flex justify-between text-orange-600">
                    ...
                    <span>
                      +
                      {(parseFloat(formData.basePrice || "0") * 0.2).toFixed(2)}{" "}
                      €
                    </span>
                  </div>
                )}
                ...
                <div className="flex justify-between font-medium text-blue-900">
                  ...
                  <span>
                    {(
                      ...
                      (formData.isUrgent
                        ? parseFloat(formData.basePrice || "0") * 0.2
                        : 0)
                    ).toFixed(2)}{" "}
                    €
                  </span>
        ...
        <div className="flex justify-end gap-4 pt-6 border-t">
          <Button type="button" variant="outline" asChild>
            <Link href="/merchant/announcements/create">Annuler</Link>
          </Button>
