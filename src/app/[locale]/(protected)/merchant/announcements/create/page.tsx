            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <Button asChild className="w-full">
                  <Link href={type.href}>Créer cette annonce</Link>
                </Button>
              </CardContent>
            </Card>
          ))}
            ...
            <Card key={option.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent className="space-y-4">
                ...
                <Button variant="outline" asChild className="w-full">
                  <Link href={option.href}>Commencer l'import</Link>
                </Button>
              </CardContent>
            </Card>
          ))}
        ...
        <CardContent className="space-y-3 text-blue-800">
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm">
              <strong>Validation :</strong> Vos annonces sont validées
              automatiquement si vous avez un contrat actif.
            </div>
          </div>
          <div className="flex items-start gap-2">
            <Package className="h-4 w-4 mt-0.5 text-blue-600" />
            <div className="text-sm">
              <strong>Limites :</strong> Respectez les limites de votre contrat
              (services autorisés, volume mensuel).
            </div>
          </div>
          <div className="flex items-start gap-2">
            <Shield className="h-4 w-4 mt-0.5 text-blue-600" />
            <div className="text-sm">
              <strong>Assurance :</strong> Toutes les livraisons sont couvertes
              selon votre niveau d'abonnement.
            </div>
          </div>
        </CardContent>
      </Card>
