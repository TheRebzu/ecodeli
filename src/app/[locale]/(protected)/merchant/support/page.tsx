  ...
  const fetchSupportData = async () => {
    try {
      ...
      const [ticketsRes, kbRes] = await Promise.all([
        ...
        fetch("/api/merchant/support/knowledge-base", {
          credentials: "include",
        }),
      ]);
  ...
  const getDemoTickets = (): SupportTicket[] => [
    {
      ...
      description:
        "J'ai besoin d'aide pour configurer les zones de livraison pour le service lâcher de chariot",
      ...
      messages: [
        {
          id: "1",
          content:
            "Bonjour, j'ai besoin d'aide pour configurer les zones de livraison. Je ne comprends pas comment définir les tarifs par zone.",
          sender: "merchant",
          senderName: "Vous",
        ...
        },
        {
          id: "2",
          content:
            "Bonjour ! Je vais vous aider avec la configuration des zones. Avez-vous déjà défini vos codes postaux de livraison ?",
          sender: "support",
      ...
      messages: [
        {
          id: "1",
          content:
            "Depuis hier, les paiements Stripe ne fonctionnent plus. Les clients reçoivent des erreurs lors du checkout.",
          sender: "merchant",
          senderName: "Vous",
  ...
  const getDemoKnowledgeBase = (): KnowledgeBaseArticle[] => [
    {
      ...
      content:
        "Le service lâcher de chariot est le service phare d'EcoDeli. Voici comment le configurer...",
      category: "Configuration",
    ...
    },
    {
      ...
      content:
        "Voici comment sont calculées vos commissions et comment optimiser vos revenus...",
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/merchant/support/tickets/${selectedTicket.id}/messages`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Support dédié aux commerçants EcoDeli - Nous sommes là pour vous
            aider
          </p>
        </div>
            ...
            <Dialog open={newTicketOpen} onOpenChange={setNewTicketOpen}>
              ...
              <DialogContent className="max-w-lg">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Décrivez votre problème en détail pour recevoir une aide
                    personnalisée
                  </DialogDescription>
                </DialogHeader>
                <NewTicketForm
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col gap-1">
                        <Badge
                          variant={
                            getStatusBadge(selectedTicket.status).variant
                          }
                        >
                        ...
                        <Badge
                          variant={
                            getPriorityBadge(selectedTicket.priority).variant
                          }
                        >
  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Info maintenance :</strong> Maintenance programmée ce dimanche
          de 2h à 4h pour améliorer les performances.
        </AlertDescription>
      </Alert>
    </div>
  );
