  ...
  const getDemoSteps = (): OnboardingStep[] => [
    {
      ...
      description:
        "Découvrez la plateforme de crowdshipping qui révolutionne la livraison",
      type: "video",
      duration: 5,
      completed: true,
      required: true,
    ...
    },
    {
      ...
      description:
        "Maîtrisez le service phare d'EcoDeli pour maximiser vos ventes",
      type: "video",
      duration: 12,
      completed: false,
      required: true,
        ...
        tutorialSteps: [
          {
            ...
            description:
              "Ajoutez les codes postaux que vous souhaitez desservir",
        ...
        tutorialSteps: [
          {
            ...
            description:
              "API, plugins Shopify/WooCommerce, ou solutions sur-mesure",
    ...
    },
    {
      ...
      description:
        "Comment sont calculées vos commissions et comment les optimiser",
      type: "video",
      duration: 8,
      completed: false,
      required: true,
        ...
        tutorialSteps: [
          {
            ...
            description:
              "Chiffre d'affaires, nombre de commandes, satisfaction client",
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description:
            "Félicitations ! Vous progressez dans votre formation EcoDeli",
        });
      }
    } catch (error) {
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Maîtrisez tous les aspects de la plateforme pour maximiser vos
              ventes
            </p>
          </div>
          {progress && (
          ...
          {activeStep ? (
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Choisissez une étape dans la liste pour voir les détails et
...
function StepDetailPanel({ step, onComplete, onClose }: StepDetailPanelProps) {
  ...
  const handleNextQuestion = () => {
    if (
      ...
      currentQuestionIndex < step.content.quizQuestions.length - 1
    ) {
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center gap-4 text-sm text-muted-foreground">
          ...
          {step.required && <Badge variant="outline">Obligatoire</Badge>}
          {step.completed && (
            ...
            {!quizCompleted ? (
              <>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">
                    ...
                    {step.content.quizQuestions.length}
                  </span>
                  <Progress
                    value={
              ...
              <div className="text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Vous avez obtenu {quizScore} /{" "}
                    {step.content.quizQuestions.length} bonnes réponses
                  </p>
                </div>
                {quizScore >= step.content.quizQuestions.length * 0.7 && (
                  <Button
        ...
        {step.type === "setup" && step.content?.tutorialSteps && (
          <div className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                Cette étape nécessite de configurer des paramètres dans votre
                compte EcoDeli
              </AlertDescription>
            </Alert>
