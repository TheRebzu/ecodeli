...
export async function POST(
  ...
  try {
    ...
    try {
      ...
      console.log('✅ Notification push envoyée au client pour refus de réservation')
    } catch (error) {
    ...
    try {
      console.log('📧 Tentative d\'envoi email de refus au client:', booking.client.user.email)
