    ...
    const testMessages = [
      {
        ...
        message:
          "Vos notifications push fonctionnent parfaitement ! Vous êtes prêt(e) à recevoir les mises à jour EcoDeli.",
        data: { type: "test", timestamp: new Date().toISOString() },
      },
      {
        title: "✅ Test réussi !",
        message:
          "Cette notification confirme que votre appareil est correctement configuré pour recevoir les alertes EcoDeli.",
        data: { type: "test_success", timestamp: new Date().toISOString() },
      },
      {
        title: "🔔 Configuration validée",
        message:
          "Excellent ! Vous recevrez maintenant toutes les notifications importantes de la plateforme EcoDeli.",
