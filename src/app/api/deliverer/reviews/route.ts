...
/**
 * GET - Récupérer les évaluations du livreur
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await ReviewService.getDelivererReviews(deliverer.id, filters)
    ...
    console.error('Error getting deliverer reviews:', error)
