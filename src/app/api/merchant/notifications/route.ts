...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await MerchantNotificationsService.getNotifications(merchantId, {
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await MerchantNotificationsService.getNotifications(merchantId, filters)
