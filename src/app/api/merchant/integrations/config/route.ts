...
export async function GET(request: NextRequest) {
  try {
    ...
    const integrationType = getIntegrationTypeFromCategory(
      category as "pos" | "inventory" | "accounting",
    );
...
function getIntegrationTypeFromCategory(
  category: "pos" | "inventory" | "accounting",
