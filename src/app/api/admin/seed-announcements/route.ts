  ...
  try {
    ...
    if (!user || !user.client) {
      return NextResponse.json(
        { error: "Utilisateur client non trouvé" },
        { status: 404 },
      );
    }
    ...
    const announcements = [
      {
        ...
        description:
          "Colis de 5kg à livrer rapidement. Documents importants à l'intérieur.",
      ...
      },
      {
        ...
        description:
          "Besoin d'aide pour transporter mes courses depuis Carrefour jusqu'à mon domicile.",
        type: "SHOPPING",
        basePrice: 15,
        isUrgent: false,
      ...
      },
      {
        ...
        description:
          "J'ai 10 cartons à déménager de mon ancien studio vers le nouveau. Besoin d'un véhicule adapté.",
        type: "PACKAGE_DELIVERY",
        basePrice: 75,
        isUrgent: false,
        pickupAddress: "78 Rue de Rennes, 75006 Paris",
        pickupLatitude: 48.85,
      ...
      },
      {
        ...
        description:
          "Besoin d'un transport pour 2 personnes avec bagages vers l'aéroport Charles de Gaulle.",
      ...
      },
      {
        ...
        description:
          "Table et 4 chaises achetées chez IKEA à livrer et monter si possible.",
        type: "PACKAGE_DELIVERY",
        basePrice: 45,
        isUrgent: false,
        pickupAddress:
      ...
      },
      {
        ...
        description:
          "Mon colis est arrivé au point relais, besoin de quelqu'un pour le récupérer et me le livrer.",
        type: "PACKAGE_DELIVERY",
        basePrice: 12,
        isUrgent: true,
      ...
      },
      {
        ...
        description:
          "Ma mère a besoin d'être accompagnée pour son rendez-vous chez le médecin. Personne autonome mais préfère être accompagnée.",
      ...
      },
      {
        ...
        description:
          "Bouquet de fleurs à récupérer chez le fleuriste et à livrer pour un anniversaire surprise.",
        type: "PACKAGE_DELIVERY",
        basePrice: 18,
        isUrgent: false,
