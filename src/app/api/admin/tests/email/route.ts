...
import { TestsService, EmailTestRequest } from '@/features/admin/services/tests.service'
import { z } from 'zod'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await TestsService.sendTestEmail(validatedData as EmailTestRequest)
