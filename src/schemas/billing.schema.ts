...
export const commissionRateSchema = z.object({
  ...
  calculationType: z.enum(['PERCENTAGE', 'FLAT_FEE', 'TIERED']).default('PERCENTAGE'),
...
export const roleBillingConfigSchema = z.object({
  ...
  billingCycle: z.enum(['DAILY', 'WEEKLY', 'BIWEEKLY', 'MONTHLY']).default('MONTHLY'),
  payoutCycle: z.enum(['DAILY', 'WEEKLY', 'BIWEEKLY', 'MONTHLY']).default('BIWEEKLY'),
...
export type UserFinancialProfileInput = z.infer<typeof userFinancialProfileSchema>;
