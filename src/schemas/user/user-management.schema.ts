...
export const updateUserStatusSchema = z.object({ userId: z.string(),
...
export const updateUserRoleSchema = z.object({ userId: z.string(),
...
export const updateUserPermissionsSchema = z.object({ userId: z.string(),
...
export const getUserDetailSchema = z.object({ userId: z.string(),
...
export const userActivityLogSchema = z.object({ userId: z.string(),
...
export const userNoteSchema = z.object({ userId: z.string(),
...
export const addUserActivityLogSchema = z.object({ userId: z.string(),
...
export const exportUsersSchema = z.object({ format: z.enum(["csv", "excel", "pdf", "json"]),
...
export const forcePasswordResetSchema = z.object({ userId: z.string(),
  reason: z.string().optional(),
  notifyUser: z.boolean().default(true),
...
export const bulkUserActionSchema = z.object({ userIds: z.array(z.string()).min(1),
  action: z.enum([
    "ACTIVATE",
    "DEACTIVATE",
    "SUSPEND",
...
export const auditLogFiltersSchema = z.object({ entityType: z.string().optional(),
...
export const userNotificationSettingsSchema = z.object({ userId: z.string(),
...
export const sendUserNotificationSchema = z.object({ userId: z.string(),
...
export const userDevicesSchema = z.object({ userId: z.string(),
...
export const userStatsAdvancedSchema = z.object({ period: z.enum(["DAY", "WEEK", "MONTH", "QUARTER", "YEAR"]).default("MONTH"),
