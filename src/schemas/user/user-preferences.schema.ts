...
export const userPreferencesSchema = z.object({ locale: z.enum(locales as [string, ...string[]]),
...
export const updateOnboardingStatusSchema = z.object({ hasCompletedOnboarding: z.boolean().optional(),
