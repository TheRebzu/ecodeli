...
export const createDetailedReviewSchema = z.object({
  ...
  pros: z.array(z.string().max(200)).max(5, 'Maximum 5 points positifs').optional(),
  cons: z.array(z.string().max(200)).max(5, 'Maximum 5 points négatifs').optional(),
...
export type CreateDetailedReviewInput = z.infer<typeof createDetailedReviewSchema>;
export type UpdateReviewInput = z.infer<typeof updateReviewSchema>;
export type ReviewFilterInput = z.infer<typeof reviewFilterSchema>;
export type ProviderRatingSearchInput = z.infer<typeof providerRatingSearchSchema>;
