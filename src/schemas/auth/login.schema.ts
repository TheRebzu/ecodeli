 ...
 */
export const forgotPasswordSchema = z.object({ email: z.string().email({ message: "Email invalide"  })});
...
export const resetPasswordSchema = z
  .object({ token: z.string().min(1, "Token manquant"),
    password: z
      .string()
      .min(8, {
 ...
 */
export const setupTwoFactorSchema = z.object({ totpCode: z
    .string()
 ...
 */
export const verifyEmailSchema = z.object({ token: z.string().min(1, "Token manquant") });

export type VerifyEmailSchemaType = z.infer<typeof verifyEmailSchema>;

// Schema for 2FA challenge when required after initial login
export const totpChallengeSchema = z.object({ totp: z
    .string()
