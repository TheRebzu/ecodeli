...
export const userStatsRequestSchema = z.object({
  includeRoleDistribution: z.boolean().default(true),
...
export const documentStatsRequestSchema = z.object({
  includePendingByRole: z.boolean().default(true),
...
export const warehouseStatsRequestSchema = z.object({
  includeWarehouseDetails: z.boolean().default(true),
});
...
export const recentActivitiesRequestSchema = z.object({
