...
export const financialTaskBaseSchema = z.object({
...
export type ScheduledBillingTaskInput = z.infer<typeof scheduledBillingTaskSchema>;
...
export type FinancialReportTaskInput = z.infer<typeof financialReportTaskSchema>;
