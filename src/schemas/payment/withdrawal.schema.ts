 ...
 */
export const WithdrawalSchema = z.object({ id: z.string().cuid().optional(),
  walletId: z.string(),
 ...
 */
export const CreateWithdrawalSchema = z.object({ amount: z.number().positive("Le montant doit être supérieur à 0"),
  currency: z.string().default("EUR"),
  preferredMethod: z
    .enum(["SEPA", "STRIPE_CONNECT", "BANK_TRANSFER"])
    .optional()
 ...
 */
export const UpdateWithdrawalStatusSchema = z.object({ id: z.string(),
 ...
 */
export const WithdrawalListFilterSchema = z.object({ status: z
    .enum(["PENDING", "PROCESSING", "COMPLETED", "FAILED", "CANCELLED"])
    .optional(),
 ...
 */
export const WithdrawalSummarySchema = z.object({ totalWithdrawn: z.number().nonnegative(),
 ...
 */
export const ProcessWithdrawalSchema = z.object({ withdrawalId: z.string(),
 ...
 */
export const WithdrawalSearchSchema = z.object({ userId: z.string().optional(),
  status: z
    .enum(["PENDING", "PROCESSING", "COMPLETED", "FAILED", "CANCELLED"])
    .optional(),
 ...
 */
export const AutomaticWithdrawalConfigSchema = z.object({ enabled: z.boolean().default(false),
 ...
 */
export const withdrawalBaseSchema = z.object({ walletId: z.string().cuid().optional(),
...
export const createWithdrawalRequestSchema = withdrawalBaseSchema
  .omit({ walletId  })
  .extend({ userId: z.string().cuid() });

/**
 * Schéma pour traiter une demande de virement (admin)
 */
export const processWithdrawalRequestSchema = z.object({ requestId: z.string().cuid(),
 ...
 */
export const finalizeBankTransferSchema = z.object({ bankTransferId: z.string().cuid(),
 ...
 */
export const withdrawalSearchSchema = z.object({ userId: z.string().cuid().optional(),
 ...
 */
export const pendingWithdrawalsSchema = z.object({ page: z.number().int().min(1).default(1),
 ...
 */
export const withdrawalDetailsSchema = z.object({ requestId: z.string().cuid(),
  userId: z.string().cuid().optional() });
 ...
 */
export const withdrawalStatsSchema = z.object({ userId: z.string().cuid() });
