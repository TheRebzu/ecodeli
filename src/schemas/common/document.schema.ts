...
export const uploadDocumentSchema = z.object({ type: documentTypeSchema,
  file: fileSchema,
...
export const updateDocumentSchema = z.object({ documentId: z.string(),
  type: documentTypeSchema.optional(),
  notes: z.string().optional(),
  expiryDate: z.date().optional() });

// Schéma pour la demande de vérification
export const createVerificationSchema = z.object({ documentId: z.string(),
  notes: z.string().optional() });

// Schéma pour la mise à jour d'une vérification par un admin
export const updateVerificationSchema = z.object({ verificationId: z.string(),
  status: verificationStatusSchema,
  notes: z.string().optional(),
  rejectionReason: z.string().optional() });

// Schema pour le filtrage des documents
export const documentFilterSchema = z.object({ status: z
