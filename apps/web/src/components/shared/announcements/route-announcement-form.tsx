                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder={t('routeTitlePlaceholder')} />
                        </FormControl>
                        <FormDescription>{t('routeTitleDescription')}</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h4 className="text-md font-medium">{t('intermediatePoints')}</h4>
                      <Button
                        type="button"
                        variant="outline"
                        size="sm"
                          ...
                          <Controller
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input {...field} placeholder={t('pointAddressPlaceholder')} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          <FormLabel className="text-base">{t('recurringRoute')}</FormLabel>
                          <FormDescription>{t('recurringRouteDescription')}</FormDescription>
                        </div>
                        <FormControl>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>{t('recurringEndDateDescription')}</FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
                      />
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                          ...
                          <div className="space-y-1 leading-none">
                            ...
                            <FormDescription>{t('acceptsFragileDescription')}</FormDescription>
                          </div>
                        </FormItem>
                      )}
                    />
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                          ...
                          <div className="space-y-1 leading-none">
                            ...
                            <FormDescription>{t('acceptsCoolingDescription')}</FormDescription>
                          </div>
                        </FormItem>
                      )}
                    />
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                          ...
                          <div className="space-y-1 leading-none">
                            ...
                            <FormDescription>{t('acceptsLiveAnimalsDescription')}</FormDescription>
                          </div>
                        </FormItem>
                      )}
                    />
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                          ...
                          <div className="space-y-1 leading-none">
                            ...
                            <FormDescription>{t('acceptsOversizedDescription')}</FormDescription>
                          </div>
                        </FormItem>
                      )}
                    />
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>{t('enableNotificationsDescription')}</FormDescription>
                        </div>
                        <FormControl>
                          <Switch checked={field.value} onCheckedChange={field.onChange} />
                        </FormControl>
                  ...
                  {enableNotifications && (
                    <Controller
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base">{t('autoMatch')}</FormLabel>
                            <FormDescription>{t('autoMatchDescription')}</FormDescription>
                          </div>
                          <FormControl>
                            <Switch checked={field.value} onCheckedChange={field.onChange} />
                          </FormControl>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>{t('preferredClientTypesDescription')}</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <Button type="submit" disabled={isSubmitting}>
                    {isSubmitting ? (
                      ...
                      <>
                        ...
                        {mode === 'create' ? t('announceRoute') : t('updateRoute')}
                      </>
                    )}
                  </Button>
                </div>
