...
interface DocumentUploadFormProps {
  ...
  onSubmit: (data: { file: File; expiryDate?: string; notes?: string }) => Promise<void>;
  isLoading?: boolean;
}
            ...
            <Alert>
              ...
              <AlertDescription>
                <div className="space-y-2">
                  <div className="font-medium">Conseils pour un document de qualité :</div>
                        ...
                        >
                          {preview ? (
                            ...
                            <div className="space-y-4">
                              ...
                              <div>
                                <h3 className="font-medium">Glissez votre document ici</h3>
                                <p className="text-sm text-muted-foreground mt-1">
                                  ou cliquez pour sélectionner un fichier
                                </p>
                                <p className="text-xs text-muted-foreground mt-2">
                                  Formats acceptés : {config?.acceptedFormats.join(', ')} • Max 10MB
                                </p>
                              </div>
                            </div>
                          )}
              ...
              <Controller
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Date d'expiration du document (optionnel)</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
