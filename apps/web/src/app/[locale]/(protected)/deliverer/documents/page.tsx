      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            {t('description', { default: 'Gérez vos documents de vérification et leur statut' })}
          </p>
        </div>
          ...
          <AlertDescription className="text-amber-800">
            <div className="flex flex-col space-y-2">
              <span className="font-medium">
                {t('verification.required', { default: 'Vérification requise' })}
              </span>
              <span>
          ...
          <AlertDescription className="text-green-800">
            ...
            <span>
              {t('verification.verified.description', {
                default: 'Votre compte est vérifié. Vous pouvez gérer vos documents ci-dessous.',
              })}
            </span>
          </AlertDescription>
        </Alert>
