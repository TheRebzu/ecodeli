...
try {
  ...
  const curlCmd = 'curl -s -o /dev/null -w "%{http_code}" http://localhost:3000/api/openapi';
  ...
  console.log('🌐 Documentation Swagger: http://localhost:3000/fr/developers/api-docs');
  console.log('📋 Documentation manuelle: http://localhost:3000/fr/developers/api-manual');
  console.log('🔧 Spécification OpenAPI: http://localhost:3000/api/openapi');
  
  console.log('\n3. Instructions:');
  console.log('- Assurez-vous d\'être connecté avec votre compte jean.dupont@orange.fr');
  console.log('- Le middleware devrait maintenant autoriser l\'accès aux chemins /developers/*');
  console.log('- Si ça redirige encore, vérifiez les logs du middleware dans la console');
