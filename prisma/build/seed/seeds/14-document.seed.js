...
async function seedDocuments(ctx) {
    ...
    const deliverers = users.filter(u => u.role === constants_1.CONSTANTS.roles.DELIVERER);
    ...
    const providers = users.filter(u => u.role === constants_1.CONSTANTS.roles.PROVIDER);
