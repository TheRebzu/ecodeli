...
const usersByRole = {
    ...
    DELIVERER: [
        { email: 'livreur1@test.com', name: 'Thomas Moreau', gender: 'male', status: 'VALIDATED' },
        { email: 'livreur2@test.com', name: 'Lucas Simon', gender: 'male', status: 'VALIDATED' },
        { email: 'livreur3@test.com', name: 'Antoine Michel', gender: 'male', status: 'PENDING_VALIDATION' },
        { email: 'livreur4@test.com', name: 'Maxime Garcia', gender: 'male', status: 'VALIDATED' },
        { email: 'livreur5@test.com', name: 'Nicolas Martinez', gender: 'male', status: 'REJECTED' },
    ],
    MERCHANT: [
    ...
    PROVIDER: [
        { email: 'prestataire1@test.com', name: 'Julie Durand', gender: 'female', status: 'VALIDATED' },
        { email: 'prestataire2@test.com', name: 'Marc Rousseau', gender: 'male', status: 'VALIDATED' },
        { email: 'prestataire3@test.com', name: 'Céline Laurent', gender: 'female', status: 'VALIDATED' },
        { email: 'prestataire4@test.com', name: 'David Fournier', gender: 'male', status: 'PENDING_DOCUMENTS' },
        { email: 'prestataire5@test.com', name: 'Sarah Girard', gender: 'female', status: 'VALIDATED' },
    ],
    ADMIN: [
        ...
        for (const userData of users) {
            ...
            const user = await prisma.user.create({
                data: {
                    ...
                    isActive: role === 'CLIENT' || role === 'ADMIN' || userData.status === 'VALIDATED',
