...
export const seedDependencies: SeedDependency[] = [
  {
    name: '00-cleanup',
    fn: async (ctx) => (await import('../seeds/00-cleanup.seed')).cleanDatabase(ctx)
  },
  {
    name: '01-users',
  ...
  {
    name: '03-client',
    fn: async (ctx) => (await import('../seeds/03-client.seed')).seedClient(ctx)
  },
  {
    name: '04-deliverer',
    fn: async (ctx) => (await import('../seeds/04-deliverer.seed')).seedDeliverer(ctx)
  },
  {
    name: '05-merchant',
    fn: async (ctx) => (await import('../seeds/05-merchant.seed')).seedMerchant(ctx)
  },
  {
    name: '06-provider',
    fn: async (ctx) => (await import('../seeds/06-provider.seed')).seedProviders(ctx)
  },
  {
    name: '07-admin',
  ...
  },
  {
    ...
    fn: async (ctx) => (await import('../seeds/13-location.seed')).seedLocations(ctx)
  },
  {
    name: '14-document', // Documents pour validation utilisateurs
    fn: async (ctx) => (await import('../seeds/14-document.seed')).seedDocuments(ctx)
  },
  {
    name: '08-announcement',
    fn: async (ctx) => (await import('../seeds/08-announcement.seed')).seedAnnouncements(ctx)
  },
  {
    name: '09-delivery',
  ...
  {
    name: '19-tracking',
    fn: async (ctx) => (await import('../seeds/19-tracking.seed')).seedTracking(ctx)
  },
  {
    name: '20-support',
    fn: async (ctx) => (await import('../seeds/20-support.seed')).seedSupport(ctx)
  },
  {
    name: '21-certifications',
    fn: async (ctx) => (await import('../seeds/21-certifications.seed')).seedCertifications(ctx)
  },
  {
    name: '22-insurance',
    fn: async (ctx) => (await import('../seeds/22-insurance.seed')).seedInsurance(ctx)
  },
  {
    name: '23-referral',
