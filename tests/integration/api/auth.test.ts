...
describe("Auth API", () => {
  beforeEach(() => {
    ...
    signOut.mockResolvedValue(
      Response.json({ success: true, message: "Logged out successfully" }, { status: 200 })
    );
    ...
    resetPassword.mockResolvedValue(
      Response.json({ success: true, message: "Password reset successful" }, { status: 200 })
    );
    
    verifyEmail.mockResolvedValue(
      Response.json({ success: true, message: "Email verified successfully" }, { status: 200 })
    );
    
    updatePassword.mockResolvedValue(
      Response.json({ success: true, message: "Password updated successfully" }, { status: 200 })
    );
    ...
    disableMfa.mockResolvedValue(
      Response.json({ success: true, message: "MFA disabled successfully" }, { status: 200 })
    );
